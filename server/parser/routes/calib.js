...
exports.SYS_GPS  =   0;                /* navigation system: GPS */
exports.SYS_GLO  =   1;                /* navigation system: GLONASS */
exports.SYS_CMP  =   2;                /* navigation system: BeiDou */
exports.SYS_GAL =  4;
exports.SYS_QZS =  5;

exports.SYS_ALL  =   3;                /* navigation system: all */


exports.TSYS_GPS =   0;                   /* time system: GPS time */
exports.TSYS_UTC =   1;                   /* time system: UTC */
exports.TSYS_GLO  =  2;                   /* time system: GLONASS time */
exports.TSYS_GAL  =  3;                   /* time system: Galileo time */
exports.TSYS_QZS  =  4;                   /* time system: QZSS time */
exports.TSYS_CMP =   5;                   /* time system: BeiDou time */
exports.TSYS_CMP_NEW =   6;               /* time system: BeiDou new time */
