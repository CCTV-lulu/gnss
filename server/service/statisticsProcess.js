...
function getTimeLine(name, data, sys, type, lineLimit) {
    ...
    var warningLine = {
        "type": "line",
        name: '警告线',
        data: [[startTime, lineLimit], [currentTime, lineLimit]],
        color: 'yellow'
    }
...
function StatisticsProcess(config, stationId, username) {
    this.config = config;
    this.filter = null;
