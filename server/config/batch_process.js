...
function satis_init(para) {
    para.id=0;
    para.bt=cmn.epoch2time([2017,5,6,0,0,0]);
    para.et=cmn.epoch2time([2017,5,7,23,59,59]);
...
function create_filestream(file, stream, type ,cb) {
...
function batch_process(test_file){
    ...
    var readfile= create_filestream(test_file, stream,function(data){
