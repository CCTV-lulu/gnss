...
(function (K, a) {
    ...
    K = function () {
        var a = window, B = a.document, C = a.navigator && a.navigator.userAgent || "", E = B && B.createElementNS && !!B.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, F = /(edge|msie|trident)/i.test(C) && !window.opera, v = !E, l = /Firefox/.test(C), q = l && 4 > parseInt(C.split("Firefox/")[1], 10);
    ...
    (function (a) {
        var B = [], C = a.charts, E = a.doc, F = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], l = this.paths[1], q = [], x = this.now, t = a.length, n;
                if (1 === x)q = this.toD; else if (t === l.length && 1 > x)for (; t--;)n = parseFloat(a[t]), q[t] = isNaN(n) ? a[t] : x * parseFloat(l[t] - n) + n; else q = l;
                this.elem.attr("d", q, null, !0)
            }, update: function () {
                var a = this.elem, l = this.prop, q = this.now, x = this.options.step;
                if (this[l + "Setter"])this[l +
                "Setter"](); else a.attr ? a.element && a.attr(l, q, null, !0) : a.style[l] = q + this.unit;
                x && x.call(a, q, this)
            }, run: function (a, l, q) {
                ...
                var l = +new Date, v, x = this.options;
                v = this.elem;
                var t = x.complete, n = x.duration, h = x.curAnim, b;
                if (v.attr && !v.element)v = !1; else if (a || l >= n + this.startTime) {
                    this.now = this.end;
                    this.pos = 1;
                    this.update();
                    a = h[this.prop] = !0;
                ...
                l = l || "";
                var h, b = v.startX, g = v.endX, A = -1 < l.indexOf("C"), u = A ? 7 : 3, p, m, d;
                l = l.split(" ");
                q = q.slice();
                var r = v.isArea, G = r ? 2 : 1, f;
                A && (x(l), x(q));
                if (b && g) {
                    for (d = 0; d < b.length; d++)if (b[d] === g[0]) {
                        h = d;
                        break
        ...
        a.merge = function () {
            var v, l = arguments, q, x = {}, t = function (n, h) {
                var b, g;
                "object" !== typeof n && (n = {});
        ...
        a.attr = function (v, l, q) {
            var x, t;
            if (a.isString(l))a.defined(q) ? v.setAttribute(l, q) : v && v.getAttribute && (t = v.getAttribute(l)); else if (a.defined(l) && a.isObject(l))for (x in l)v.setAttribute(x, l[x]);
            return t
        };
        a.splat = function (v) {
        ...
        a.pick = function () {
            var a = arguments, l, q, x = a.length;
            for (l =
                     0; l < x; l++)if (q = a[l], void 0 !== q && null !== q)return q
        };
        a.css = function (v, l) {
        ...
        a.createElement = function (v, l, q, x, t) {
            ...
            var n = a.css;
            l && a.extend(v, l);
            t && n(v, {padding: 0, border: "none", margin: 0});
            q && n(v, q);
            x && x.appendChild(v);
            return v
        };
        ...
        a.wrap = function (a, l, q) {
            var v = a[l];
            a[l] = function () {
                var a = Array.prototype.slice.call(arguments), n = arguments, h = this;
                h.proceed = function () {
        ...
        a.dateFormat = function (v, l, q) {
            ...
            var x = a.Date, t = new x(l - a.getTZOffset(l)), n, h = t[x.hcGetHours](), b = t[x.hcGetDay](), g = t[x.hcGetDate](), A = t[x.hcGetMonth](), u = t[x.hcGetFullYear](), p = a.defaultOptions.lang, m = p.weekdays, d = p.shortWeekdays, r = a.pad, x = a.extend({
            ...
            for (n in x)for (; -1 !== v.indexOf("%" + n);)v = v.replace("%" + n, "function" === typeof x[n] ? x[n](l) : x[n]);
            return q ? v.substr(0, 1).toUpperCase() + v.substr(1) : v
        };
        a.formatSingle = function (v, l) {
            var q = /\.([0-9])/, x = a.defaultOptions.lang;
        ...
        a.numberFormat =
            function (v, l, q, x) {
                v = +v || 0;
                l = +l;
                var t = a.defaultOptions.lang, n = (v.toString().split(".")[1] || "").length, h, b, g = Math.abs(v);
                -1 === l ? l = Math.min(n, 20) : a.isNumber(l) || (l = 2);
        ...
        a.removeEvent = function (v, l, q) {
            ...
            function t() {
                var a, b;
                if (v.nodeName)for (b in l ? (a = {}, a[l] = !0) : a = h, a)if (h[b])for (a =
                                                                                              h[b].length; a--;)x(b, h[b][a])
            }

            var n, h = v.hcEvents, b;
        ...
        a.fireEvent = function (v, l, q, x) {
            ...
            var n, h;
            q = q || {};
            if (E.createEvent && (v.dispatchEvent || v.fireEvent))t = E.createEvent("Events"), t.initEvent(l, !0, !0), a.extend(t, q), v.dispatchEvent ? v.dispatchEvent(t) : v.fireEvent(l, t); else if (t)for (t = t[l] || [], n = t.length, q.target || a.extend(q, {
        ...
        a.animate = function (v, l, q) {
            var x, t = "", n, h, b;
            a.isObject(q) || (x = arguments, q = {duration: x[2], easing: x[3], complete: x[4]});
        ...
        a.seriesType = function (v, l, q, x, t) {
            var n = a.getOptions(), h = a.seriesTypes;
            n.plotOptions[v] = a.merge(n.plotOptions[l], q);
            h[v] = a.extendClass(h[l] || function () {
                }, x);
        ...
        a.uniqueKey = function () {
            var a = Math.random().toString(36).substring(2, 9), l = 0;
            return function () {
        ...
        E && !E.defaultView && (a.getStyle = function (v, l) {
            var q = {width: "clientWidth", height: "clientHeight"}[l];
        ...
        Array.prototype.forEach || (a.each = function (a, l, q) {
            for (var x = 0, t = a.length; x < t; x++)if (!1 === l.call(q, a[x], x, a))return x
        });
        Array.prototype.indexOf || (a.inArray = function (a, l) {
            var q, x = 0;
            if (l)for (q = l.length; x < q; x++)if (l[x] === a)return x;
            return -1
        });
        ...
        Array.prototype.find || (a.find = function (a, l) {
            var q,
                x = a.length;
            for (q = 0; q < x; q++)if (l(a[q], q))return a[q]
        })
    })(K);
    (function (a) {
        var B = a.each, C = a.isNumber, E = a.map, F = a.merge, v = a.pInt;
        a.Color = function (l) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                }); else for (t = this.parsers.length; t-- && !x;)n = this.parsers[t], (q = n.regex.exec(l)) && (x = n.parse(q));
                this.rgba = x || []
            }, get: function (a) {
                var l = this.input, x = this.rgba, t;
                this.stops ?
                ...
                if (this.stops)B(this.stops, function (t) {
                    t.brighten(a)
                }); else if (C(a) && 0 !== a)for (l = 0; 3 > l; l++)x[l] += v(255 * a), 0 > x[l] && (x[l] = 0), 255 < x[l] && (x[l] = 255);
                return this
    ...
    (function (a) {
        ...
        B.prototype = {
            ...
            colorGradient: function (k, J, e) {
                var f = this.renderer, N, b, w, d, m, H, D, z, p, y, u, g = [], h;
                ...
                if (b) {
                    ...
                    r(w) && (k[b] = w = {
                        ...
                        y2: w[3], gradientUnits: "userSpaceOnUse"
                    });
                    "radialGradient" === b && y && !n(w.gradientUnits) && (d = w, w = c(w, f.getRadialAttr(y, d), {gradientUnits: "userSpaceOnUse"}));
            ...
            applyTextOutline: function (a) {
                var k = this.element, c, e, f, b;
                -1 !== a.indexOf("contrast") && (a = a.replace(/contrast/g, this.renderer.getContrast(k.style.fill)));
                this.fakeTS = !0;
            ...
            attr: function (a, c, e, f) {
                var J, b = this.element, w, N = this, d;
            ...
            addClass: function (a, k) {
                ...
                -1 === c.indexOf(a) && (k || (a = (c + (c ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function (a) {
            ...
            css: function (a) {
                var k = this.styles, c = {}, e = this.element, b, w, d = "";
                b = !k;
                a && a.color && (a.fill = a.color);
                if (k)for (w in a)a[w] !== k[w] && (c[w] = a[w], b = !0);
                if (b) {
            ...
            updateTransform: function () {
                var a = this.translateX || 0, k = this.translateY || 0, c = this.scaleX, e = this.scaleY, f = this.inverted, b = this.rotation, w = this.element;
            ...
            getBBox: function (a, k) {
                var c, e = this.renderer, b, w = this.element, d = this.styles, J, m = this.textStr, H, z = e.cache, r = e.cacheKeys,
                    p;
                k = D(k, this.rotation);
                b = k * h;
                J = d && d.fontSize;
            ...
            add: function (a) {
                var k = this.renderer, c = this.element, e;
            ...
            destroy: function () {
                var a = this.element || {}, c = this.renderer.isSVG &&
                    "SPAN" === a.nodeName && this.parentGroup, e, f;
            ...
            shadow: function (a, k, c) {
                var e = [], f, b, w = this.element, d, m, H, J;
            ...
            zIndexSetter: function (a, k) {
                var c = this.renderer, e = this.parentGroup, f = (e || c).element || c.box, b, w = this.element, d;
                b = this.added;
                var m;
        ...
        C.prototype = {
            Element: B, SVG_NS: R, init: function (a, k, c, e, f, b) {
                var w;
                e = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"}).css(this.getStyle(e));
                w = e.element;
                a.appendChild(w);
                -1 === a.innerHTML.indexOf("xmlns") && v(w, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = w;
                this.boxWrapper = e;
                this.alignedObjects = [];
                ...
                G && a.getBoundingClientRect && (k = function () {
                    ...
                    x(a, {left: Math.ceil(d.left) - d.left + "px", top: Math.ceil(d.top) - d.top + "px"})
                ...
                k.init(this, a);
                return k
            }, draw: w, getRadialAttr: function (a, k) {
                ...
                b || L || n || h || -1 !== f.indexOf(" ") ? (d = /<.*class="([^"]+)".*>/, z = /<.*style="([^"]+)".*>/, r = /<.*href="(http[^"]+)".*>/, M && M.appendChild(k), f = b ? f.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g,
                    ...
                    A(w, function (f) {
                        if ("" !== f || 1 === w.length) {
                            var D = {}, J = g.createElementNS(c.SVG_NS, "tspan"), I, A;
                            d.test(f) && (I = f.match(d)[1], v(J, "class", I));
                            z.test(f) && (A = f.match(z)[1].replace(/(;| |^)color([ :])/,
                                "$1fill$2"), v(J, "style", A));
                            r.test(f) && !e && (v(J, "onclick", 'location.href\x3d"' + f.match(r)[1] + '"'), x(J, {cursor: "pointer"}));
                            ...
                            if (" " !== f) {
                                ...
                                v(J, D);
                                k.appendChild(J);
                                !m && b && (!H && e && x(J, {display: "block"}), v(J, "dy", N(J)));
                                if (h) {
                ...
                var z = this.label(a, k, e, D, null, null, null, null, "button"), r = 0;
                z.attr(c({padding: 8, r: 2}, w));
                var p, J, y, g;
                w = c({
                    fill: "#f7f7f7",
                    stroke: "#cccccc",
                ...
                J = d.style;
                delete d.style;
                m = c(w, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, m);
                y = m.style;
                delete m.style;
                H = c(w, {style: {color: "#cccccc"}}, H);
                g = H.style;
                delete H.style;
                ...
                z.attr(w).css(u({cursor: "default"}, p));
            ...
            circle: function (a, k, c) {
                ...
                a = this.symbol("arc", a || 0, k || 0, c || 0, c || 0, {innerR: f || 0, start: e || 0, end: b || 0});
                a.r = c;
                return a
            }, rect: function (a, k, c, f, e, b) {
                e = z(a) ? a.r : e;
                var w = this.createElement("rect");
                a = z(a) ? a : void 0 === a ? {} : {x: a, y: k, width: Math.max(c, 0), height: Math.max(f, 0)};
                ...
                1 < arguments.length && u(b, {x: k, y: c, width: f, height: e});
                ...
                var w = this, d, m = this.symbols[a], H = n(k) && m && m(Math.round(k), Math.round(c), f, e, b), z = /^url\((.*?)\)$/, r, p;
                m ? (d = this.path(H), d.attr("fill", "none"), u(d, {
                    ...
                    d[a + "Setter"] = function (a, k) {
                        var c = {}, f = this["img" + k], e = "width" === k ? "translateX" : "translateY";
                        this[k] = a;
                    ...
                    x: k,
                    y: c
                }), d.isImg = !0, n(d.imgwidth) && n(d.imgheight) ? p() : (d.attr({width: 0, height: 0}), t("img", {
                    onload: function () {
                        var a =
                            l[w.chartIndex];
                        0 === this.width && (x(this, {position: "absolute", top: "-999em"}), g.body.appendChild(this));
                        M[r] = {width: this.width, height: this.height};
                ...
                circle: function (a, k, c, f) {
                    ...
                    var w = e.end - .001;
                    f = e.innerR;
                    var d = e.open, m = Math.cos(b), H = Math.sin(b), D = Math.cos(w), w = Math.sin(w);
                    ...
                    var b = Math.min(e && e.r || 0, c, f), w = b + 6, d = e && e.anchorX;
                    e = e && e.anchorY;
                    var m;
                ...
                var b = a.uniqueKey(), w = this.createElement("clipPath").attr({id: b}).add(this.defs);
                ...
                f || (a.xSetter = function (a, k, c) {
                    var f = c.getElementsByTagName("tspan"), e, b = c.getAttribute(k), w;
                ...
                return {x: -a / 3 * Math.sin(k * h), y: f}
            }, label: function (a, k, f, e, b, w, d, m, H) {
                var D = this, z = D.g("button" !== H && "label"), r = z.text = D.text("", 0, 0, d).attr({zIndex: 1}), p, y, g = 0, h = 3, I = 0, G, J, t, R, M, l = {}, q, O, x = /^url\((.*?)\)$/.test(e), v = x, P, S, Q, N;
                ...
                Q = function () {
                    var a = I + h, k;
                    k = m ? 0 : O;
                    n(G) && y && ("center" === M || "right" === M) && (a += {center: .5, right: 1}[M] * (G - y.width));
                ...
                z.onAdd = function () {
                    r.add(z);
                    z.attr({text: a || 0 === a ? a : "", x: k, y: f});
                    p && n(b) && z.attr({anchorX: b, anchorY: w})
                };
    ...
    (function (a) {
        var B = a.attr, C = a.createElement, E = a.css, F = a.defined, v = a.each, l = a.extend, q =
            a.isFirefox, x = a.isMS, t = a.isWebKit, n = a.pInt, h = a.SVGRenderer, b = a.win, g = a.wrap;
        l(a.SVGElement.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, b = this.element, p = this.translateX || 0, m = this.translateY || 0, d = this.x || 0, r = this.y || 0, g = this.textAlign || "left", f = {
                        left: 0,
                        center: .5,
                        right: 1
                    }[g], z = this.styles;
                    E(b, {marginLeft: p, marginTop: m});
                    ...
                    if ("SPAN" === b.tagName) {
                        var e = this.rotation, y = n(this.textWidth), c = z && z.whiteSpace, w = [e,
                            g, b.innerHTML, this.textWidth, this.textAlign].join();
                        ...
                        E(b, {left: d + (this.xCorr || 0) + "px", top: r + (this.yCorr || 0) + "px"});
                        t && (z = b.offsetHeight);
                        this.cTT = w
                    }
        ...
        l(h.prototype, {
            html: function (a, b, p) {
                var m = this.createElement("span"), d = m.element, r = m.renderer, u = r.isSVG, f = function (a, f) {
                ...
                m.attr({text: a, x: Math.round(b), y: Math.round(p)}).css({
                    ...
                    if (this.parentGroup =
                        ...
                        if (e = a.div, !e) {
                            ...
                            v(c.reverse(), function (a) {
                                ...
                                l(a, {
                                    on: function () {
                                        m.on.apply({element: c[0].div}, arguments);
                                        return a
    ...
    (function (a) {
        var B, C, E = a.createElement, F = a.css, v = a.defined, l = a.deg2rad, q = a.discardElement, x = a.doc, t = a.each, n = a.erase, h = a.extend;
        B = a.extendClass;
        var b = a.isArray, g = a.isNumber, A = a.isObject, u = a.merge;
        C = a.noop;
        var p = a.pick, m = a.pInt, d = a.SVGElement, r = a.SVGRenderer, G = a.win;
        a.svg || (C = {
            docMode8: x && 8 === x.documentMode, init: function (a, b) {
                var f = ["\x3c", b, ' filled\x3d"f" stroked\x3d"f"'],
                    d = ["position: ", "absolute", ";"], c = "div" === b;
                ...
                var f = this.renderer, e = this.element, b = f.box, c = a && a.inverted, b = a ? a.element || a : b;
                a && (this.parentGroup = a);
                c && f.invertChild(e, b);
                b.appendChild(e);
                this.added = !0;
                ...
                return this
            }, updateTransform: d.prototype.htmlUpdateTransform, setSpanRotation: function () {
                var a = this.rotation, b = Math.cos(a * l), e = Math.sin(a * l);
                F(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11\x3d", b, ", M12\x3d", -e, ", M21\x3d", e, ", M22\x3d", b, ", sizingMethod\x3d'auto expand')"].join("") : "none"})
            }, getSpanCorrection: function (a, b, e, d, c) {
                var f = d ? Math.cos(d * l) : 1, m = d ? Math.sin(d * l) : 0, z = p(this.elemHeight, this.element.offsetHeight),
                    r;
                this.xCorr = 0 > f && -a;
                this.yCorr = 0 > m && -z;
                r = 0 > f * m;
                ...
                c && "left" !== c && (this.xCorr -= a * e * (0 > f ? -1 : 1), d && (this.yCorr -= z * e * (0 > m ? -1 : 1)), F(this.element, {textAlign: c}))
                ...
                return f.css(a)
            }, css: d.prototype.htmlCss, safeRemoveChild: function (a) {
                a.parentNode && q(a)
            }, destroy: function () {
                ...
                var f = [], c, d = this.element, r = this.renderer, z, g = d.style, k, H = d.path, u, h, G, A;
                ...
                if (a) {
                    ...
                    for (c = 1; 3 >= c; c++)u = 2 * G + 1 - 2 * c, e && (h = this.cutOffPath(H.value, u + .5)), k = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', u, '" filled\x3d"false" path\x3d"', h, '" coordsize\x3d"10 10" style\x3d"', d.style.cssText, '" /\x3e'], z = E(r.prepVML(k), null, {
                        left: m(g.left) +
                        p(a.offsetX, 1), top: m(g.top) + p(a.offsetY, 1)
                ...
                if (f)for (e = f.length; e--;)f[e].path = f[e].cutOff ? this.cutOffPath(a, f[e].cutOff) : a;
                this.setAttr(b, a)
            ...
            }, opacitySetter: C, rotationSetter: function (a, b, e) {
                e = e.style;
                this[b] = e[b] = a;
            ...
            Element: C, isIE8: -1 < G.navigator.userAgent.indexOf("MSIE 8.0"), init: function (a, b, e) {
                var f, c;
                this.alignedObjects = [];
                ...
                var c = this.createElement(), f = A(a);
                return h(c, {
                    members: [],
                    count: 0,
                    left: (f ? a.x : a) + 1,
                    ...
                    getCSS: function (a) {
                        var c = a.element, b = c.nodeName, k = a.inverted, f = this.top - ("shape" === b ? c.offsetTop : 0), e = this.left, c = e + this.width, d = f + this.height, f = {
                            clip: "rect(" + Math.round(k ?
                                e : f) + "px," + Math.round(k ? d : c) + "px," + Math.round(k ? c : d) + "px," + Math.round(k ? f : e) + "px)"
                        };
                        !k && a.docMode8 && "DIV" === b && h(f, {width: c + "px", height: d + "px"});
                        return f
                    },
                ...
                var c = this, f, r = /^rgba/, p, g, k = "none";
                b && b.linearGradient ? g = "gradient" : b && b.radialGradient && (g = "pattern");
                if (g) {
                    var H, z, u = b.linearGradient || b.radialGradient, h, y, G, A, n, l = "";
                    b = b.stops;
                    var q, x = [], v = function () {
                    ...
                    if ("fill" === e)if ("gradient" === g)e = u.x1 || u[0] || 0, b = u.y1 || u[1] || 0, h = u.x2 || u[2] || 0, u = u.y2 || u[3] || 0, l = 'angle\x3d"' + (90 - 180 * Math.atan((u - b) / (h - e)) / Math.PI) + '"',
                        v(); else {
                        var k = u.r, C = 2 * k, B = 2 * k, F = u.cx, U = u.cy, T = d.radialReference, K, k = function () {
                ...
                1 < arguments.length && f.attr({x: b, y: e, width: d, height: c});
                return f
            }, createElement: function (a) {
                ...
                arc: function (a, b, e, d, c) {
                    var f = c.start, m = c.end, r = c.r || e || d;
                    e = c.innerR;
                    d = Math.cos(f);
                    var p = Math.sin(f), k = Math.cos(m), H = Math.sin(m);
                    if (0 === m - f)return ["x"];
    ...
    (function (a) {
        function B() {
            var x = a.defaultOptions.global, t, n = x.useUTC, h = n ? "getUTC" : "get", b = n ? "setUTC" : "set";
        ...
        var C = a.color, E = a.each, F = a.getTZOffset, v = a.merge, l = a.pick, q = a.win;
        a.defaultOptions = {
    ...
    (function (a) {
        var B = a.arrayMax, C = a.arrayMin, E = a.defined,
            F = a.destroyObjectProperties, v = a.each, l = a.erase, q = a.merge, x = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var a = this, n = a.axis, h = n.horiz, b = a.options, g = b.label, A = a.label, u = b.to, p = b.from, m = b.value, d = E(p) && E(u), r = E(m), G = a.svgElem, f = !G, z = [], e, y = b.color, c = x(b.zIndex, 0), w = b.events, z = {"class": "highcharts-plot-" + (d ? "band " : "line ") + (b.className || "")}, D = {}, I = n.chart.renderer, L = d ? "bands" : "lines", k = n.log2lin;
                n.isLog && (p = k(p), u =
                    k(u), m = k(m));
                r ? (z = {
                    stroke: y,
                ...
                if (r)z = n.getPlotLinePath(m, G.strokeWidth()); else if (d)z = n.getPlotBandPath(p, u, b); else return;
                if (f && z && z.length) {
                    if (G.attr({d: z}), w)for (e in b = function (k) {
                        G.on(k, function (b) {
                            w[k].apply(a, [b])
                        })
                    }, w)b(e)
                } else G &&
                (z ? (G.show(), G.animate({d: z})) : (G.hide(), A && (a.label = A = A.destroy())));
                ...
                var g = this.label, A = this.axis.chart.renderer;
                g || (g = {
                ...
                h = C(b);
                A = C(n);
                g.align(a, !1, {x: h, y: A, width: B(b) - h, height: B(n) - A});
                g.show()
            }, destroy: function () {
        ...
        a.AxisPlotLineOrBandExtension = {
            getPlotBandPath: function (a, n) {
                ...
                var h = (new a.PlotLineOrBand(this, l)).render(), b = this.userOptions;
    ...
    (function (a) {
        var B = a.correctFloat, C = a.defined, E = a.destroyObjectProperties, F = a.isNumber, v = a.merge, l = a.pick, q = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, t = a.options, n = a.chart, h = a.categories, b = a.names, g = this.pos, A = t.labels, u = a.tickPositions, p = g === u[0], m = g === u[u.length - 1], b = h ? l(h[g],
                    b[g], g) : g, h = this.label, u = u.info, d;
                ...
                C(h) ? h && h.attr({text: t}) : (this.labelLength = (this.label = h = C(t) && A.enabled ? n.renderer.text(t, 0, 0, A.useHTML).css(v(A.style)).add(a.labelGroup) : null) && h.getBBox().width, this.rotation = 0)
            }, getLabelSize: function () {
                return this.label ? this.label.getBBox()[this.axis.horiz ?
                    "height" : "width"] : 0
            }, handleOverflow: function (a) {
                var t = this.axis, n = a.x, h = t.chart.chartWidth, b = t.chart.spacing, g = l(t.labelLeft, Math.min(t.pos, b[3])), b = l(t.labelRight, Math.max(t.pos + t.len, h - b[1])), A = this.label, u = this.rotation, p = {
                    left: 0,
                    center: .5,
                    right: 1
                }[t.labelAlign], m = A.getBBox().width, d = t.getSlotWidth(), r = d, G = 1, f, z = {};
                if (u)0 > u && n - p * m < g ? f = Math.round(n / Math.cos(u * q) - g) : 0 < u && n + p * m > b && (f = Math.round((h - n) / Math.cos(u * q))); else if (h = n + (1 - p) * m, n - p * m < g ? r = a.x + r * (1 - p) - g : h > b && (r = b - a.x + r * p, G = -1), r = Math.min(d,
                ...
                var b = this.axis, g = b.chart, A = h && g.oldChartHeight || g.chartHeight;
                return {
                ...
                var p = this.axis, m = p.transA, d = p.reversed, r = p.staggerLines, G = p.tickRotCorr || {
                        x: 0,
                        y: 0
                    }, f = b.y;
                ...
                var h = this.axis, b = h.options, g = h.chart.renderer, A = h.horiz, u = this.type, p = this.label, m = this.pos, d = b.labels, r = this.gridLine, G = u ? u + "Tick" : "tick", f = h.tickSize(G), z = this.mark, e = !z, y = d.step, c = {}, w = !0, D = h.tickmarkOffset, I = this.getPosition(A, m, D, q), L = I.x, I = I.y, k = A && L === h.pos + h.len || !A && I === h.pos ? -1 : 1, H = u ? u + "Grid" : "grid", R = b[H + "LineWidth"], M = b[H + "LineColor"], t = b[H + "LineDashStyle"], H = l(b[G + "Width"], !u && h.isXAxis ? 1 : 0), G = b[G + "Color"];
                n = l(n, 1);
                this.isActive = !0;
                r || (c.stroke =
    ...
    (function (a) {
        ...
        a.Axis.prototype = {
            ...
            init: function (a, b) {
                ...
                -1 === d(this, a.axes) && (k ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            ...
            defaultLabelFormatter: function () {
                var k = this.axis, b = this.value, c = k.categories, e = this.dateTimeLabelFormat, d = x.lang, f = d.numericSymbols, d = d.numericSymbolMagnitude || 1E3, w = f && f.length, m, r = k.options.labels.format,
                    k = k.isLog ? b : k.tickInterval;
                if (r)m = u(r, this); else if (c)m = b; else if (e)m = a.dateFormat(e, b); else if (w && 1E3 <= k)for (; w-- && void 0 === m;)c = Math.pow(d, w + 1), k >= c && 0 === 10 * b % c && null !== f[w] && 0 !== b && (m = a.numberFormat(b / c, -1) + f[w]);
            ...
            getSeriesExtremes: function () {
                ...
                b(a.series, function (k) {
                    if (k.visible || !c.options.chart.ignoreHiddenSeries) {
                        var b = k.options, e = b.threshold, d;
            ...
            translate: function (a, b, c, e, d, f) {
                var k = this.linkedParent || this, w = 1, m = 0, r = e ? k.oldTransA : k.transA;
                e = e ? k.oldMin : k.min;
            ...
            getPlotLinePath: function (a, b, c, e, d) {
                var k = this.chart, f = this.left, w = this.top, m, r, H = c && k.oldChartHeight || k.chartHeight, p = c && k.oldChartWidth || k.chartWidth, D;
                m = this.transB;
            ...
            getLinearTickPositions: function (a, b, c) {
                var k, e = q(Math.floor(b / a) * a), d = q(Math.ceil(c / a) * a), f = [];
                if (b === c && G(b))return [b];
                for (b = e; b <= d;) {
                    f.push(b);
                    b = q(b + a);
            ...
            getMinorTickPositions: function () {
                var a = this.options, b = this.tickPositions, c = this.minorTickInterval, e = [], d, f = this.pointRangePadding || 0;
                d = this.min - f;
                var f = this.max + f, w = f - d;
                if (w && w / c < this.len / 3)if (this.isLog)for (f = b.length, d = 1; d < f; d++)e = e.concat(this.getLogTickPositions(c, b[d - 1], b[d], !0)); else if (this.isDatetimeAxis &&
                    "auto" === a.minorTickInterval)e = e.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c), d, f, a.startOfWeek)); else for (b = d + (b[0] - d) % c; b <= f && b !== e[0]; b += c)e.push(b);
                0 !== e.length && this.trimTicks(e, a.startOnTick, a.endOnTick);
                return e
            },
            adjustForMinRange: function () {
                var a = this.options, c = this.min, e = this.max, d, f = this.dataMax - this.dataMin >= this.minRange, w, m, r, p, D, g;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (t(a.min) || t(a.max) ? this.minRange = null : (b(this.series, function (a) {
                    ...
                    for (m = D = a.xIncrement ?
                        1 : p.length - 1; 0 < m; m--)if (r = p[m] - p[m - 1], void 0 === w || r < w)w = r
            ...
            nameToX: function (a) {
                var b = r(this.categories), k = b ? this.categories : this.names, c = a.options.x, e;
                a.series.requireSorting = !1;
                t(c) || (c = !1 === this.options.uniqueNames ? a.series.autoIncrement() : d(a.name, k));
            ...
            setAxisTranslation: function (a) {
                var k = this, c = k.max - k.min, e = k.axisPointRange || 0, d, w = 0, m = 0, r = k.linkedParent, p = !!k.categories, D = k.transA, g = k.isXAxis;
            ...
            setTickInterval: function (k) {
                var c = this, d = c.chart, f = c.options, w = c.isLog, m = c.log2lin, r = c.isDatetimeAxis, D = c.isXAxis,
                    g = c.isLinked, u = f.maxPadding, h = f.minPadding, z = f.tickInterval, I = f.tickPixelInterval, n = c.categories, L = c.threshold, l = c.softThreshold, x, v, C, B;
            ...
            setTickPositions: function () {
                var a = this.options, c, b = a.tickPositions, e = a.tickPositioner, d = a.startOnTick, f = a.endOnTick, w;
            ...
            trimTicks: function (a, c, b) {
                var k = a[0], e = a[a.length - 1], d = this.minPointOffset || 0;
                if (c)this.min = k; else for (; this.min - d > a[0];)a.shift();
                if (b)this.max = e; else for (; this.max + d < a[a.length - 1];)a.pop();
            ...
            adjustTickAmount: function () {
                var a = this.tickInterval, c = this.tickPositions, b = this.tickAmount, e = this.finalTickAmt, d = c && c.length;
                if (d < b) {
            ...
            zoom: function (a,
                            c) {
                var b = this.dataMin, k = this.dataMax, e = this.options, d = Math.min(b, y(e.min, b)), e = Math.max(k, y(e.max, k));
                if (a !== this.min || c !== this.max)this.allowZoomOutside || (t(b) && (a < d && (a = d), a > e && (a = e)), t(k) && (c < d && (c = d), c > e && (c = e))), this.displayBtn = void 0 !== a || void 0 !== c, this.setExtremes(a, c, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var a = this.chart, c = this.options, b = c.offsetLeft || 0, e = this.horiz, d = y(c.width, a.plotWidth - b + (c.offsetRight || 0)), f = y(c.height, a.plotHeight), w = y(c.top, a.plotTop), c = y(c.left,
                    a.plotLeft + b), b = /%$/;
            ...
            getThreshold: function (a) {
                var c = this.isLog, b = this.lin2log, k = c ? b(this.min) : this.min, c = c ? b(this.max) : this.max;
            ...
            tickSize: function (a) {
                var c = this.options, b = c[a + "Length"], k = y(c[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            unsquish: function () {
                var a = this.options.labels, c = this.horiz, e = this.tickInterval, d = e, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), w, m = a.rotation, r = this.labelMetrics(), p, D = Number.MAX_VALUE, g, u = function (a) {
                    a /= f || 1;
                    a = 1 < a ? Math.ceil(a) : 1;
                    return a * e
                };
            ...
            getSlotWidth: function () {
                var a = this.chart, c = this.horiz, b = this.options.labels, e = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), d = a.margin[3];
                return c && 2 > (b.step || 0) && !b.rotation && (this.staggerLines || 1) * a.plotWidth / e || !c && (d && d - a.spacing[3] || .33 * a.chartWidth)
            },
            renderUnsquish: function () {
                var a = this.chart, c = a.renderer, e = this.tickPositions, d = this.ticks, w = this.options.labels, m = this.horiz,
                    r = this.getSlotWidth(), p = Math.max(1, Math.round(r - 2 * (w.padding || 5))), D = {}, g = this.labelMetrics(), u = w.style && w.style.textOverflow, h, y = 0, G, I;
                f(w.rotation) || (D.rotation = w.rotation || 0);
                b(e, function (a) {
                    (a = d[a]) && a.labelLength > y && (y = a.labelLength)
                });
                this.maxLabelLength = y;
                if (this.autoRotation)y > p && y > g.h ? D.rotation = this.labelRotation : this.labelRotation = 0; else if (r && (h = {width: p + "px"}, !u))for (h.textOverflow = "clip", G = e.length; !m && G--;)if (I = e[G], p = d[I].label)p.styles && "ellipsis" === p.styles.textOverflow ? p.css({textOverflow: "clip"}) :
                d[I].labelLength > r && p.css({width: r + "px"}), p.getBBox().height > this.len / e.length - (g.h - g.f) && (p.specCss = {textOverflow: "ellipsis"});
                D.rotation && (h = {width: (y > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px"}, u || (h.textOverflow = "ellipsis"));
            ...
            addTitle: function (a) {
                var c = this.chart.renderer, b = this.horiz, k = this.opposite, e = this.options.title, d;
            ...
            getOffset: function () {
                var a = this, c = a.chart, e = c.renderer, d = a.options, f = a.tickPositions, w = a.ticks, m = a.horiz, r = a.side, p = c.inverted ? [1, 0, 3, 2][r] : r, D, g, u = 0, h, z = 0, G = d.title, I = d.labels, A = 0, n = c.axisOffset, c = c.clipOffset, l = [-1, 1, 1, -1][r], q, x = d.className, v = a.axisParent, C = this.tickSize("tick");
                D = a.hasData();
                a.showAxis = g = D || y(d.showEmpty, !0);
                a.staggerLines = a.horiz && I.staggerLines;
                a.axisGroup || (a.gridGroup = e.g("grid").attr({zIndex: d.gridZIndex || 1}).addClass("highcharts-" +
                    this.coll.toLowerCase() + "-grid " + (x || "")).add(v), a.axisGroup = e.g("axis").attr({zIndex: d.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (x || "")).add(v), a.labelGroup = e.g("axis-labels").attr({zIndex: I.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (x || "")).add(v));
                ...
                }), a.staggerLines && (A *= a.staggerLines, a.labelOffset = A * (a.opposite ? -1 : 1)); else for (q in w)w[q].destroy(), delete w[q];
            ...
            getLinePath: function (a) {
                var c = this.chart, b = this.opposite, k = this.offset, e = this.horiz, d = this.left + (b ? this.width : 0) + k, k = c.chartHeight - this.bottom - (b ? this.height : 0) + k;
                b && (a *= -1);
            ...
            getTitlePosition: function () {
                var a = this.horiz, c = this.left, b = this.top, e = this.len, d = this.options.title, f = a ? c : b, w = this.opposite, m = this.offset, r = d.x || 0, p = d.y || 0, D = this.chart.renderer.fontMetrics(d.style && d.style.fontSize, this.axisTitle).f, e = {
                    low: f + (a ? 0 : e),
                    middle: f + e / 2,
                    high: f + (a ? e : 0)
                }[d.align], c = (a ? b + this.height : c) + (a ? 1 : -1) *
            ...
            render: function () {
                var a = this, e = a.chart, d = e.renderer, f = a.options, w = a.isLog, m = a.lin2log, r = a.isLinked, p = a.tickPositions, D = a.axisTitle, g = a.ticks, u = a.minorTicks, h = a.alternateBands, z = f.stackLabels, y = f.alternateGridColor, A = a.tickmarkOffset, n = a.axisLine, l = e.hasRendered && G(a.oldMin), q = a.showAxis, t = C(d.globalAnimation), x, v;
                ...
                n && (n[n.isPlaced ? "animate" :
                    "attr"]({d: this.getLinePath(n.strokeWidth())}), n.isPlaced = !0, n[q ? "show" : "hide"](!0));
            ...
            destroy: function (a) {
                var c = this, e = c.stacks, k, f = c.plotLinesAndBands, m;
                a || w(c);
                for (k in e)h(e[k]),
                    e[k] = null;
            ...
            drawCrosshair: function (a, c) {
                var b, e = this.crosshair, k = y(e.snap, !0), d, f = this.cross;
                ...
                }), e.dashStyle && f.attr({dashstyle: e.dashStyle})),
                    f.show().attr({d: b}), c && !e.width && f.attr({"stroke-width": this.transA}), this.cross.e = a) : this.hideCrosshair()) : this.hideCrosshair()
            },
    ...
    (function (a) {
        var B = a.Axis, C = a.Date, E = a.dateFormat, F = a.defaultOptions, v = a.defined, l = a.each, q = a.extend, x = a.getMagnitude, t = a.getTZOffset, n = a.normalizeTickInterval, h = a.pick, b = a.timeUnits;
        B.prototype.getTimeTicks = function (a, A, u, p) {
            var m = [], d = {}, r = F.global.useUTC, g, f = new C(A - t(A)), z = C.hcMakeTime,
                e = a.unitRange, y = a.count, c;
            if (v(A)) {
                ...
                g = f[C.hcGetFullYear]();
                p = f[C.hcGetMonth]();
                var w = f[C.hcGetDate](), D = f[C.hcGetHours]();
            ...
            m.info = q(a, {higherRanks: d, totalRange: e * y});
            return m
        };
        B.prototype.normalizeTimeTickInterval = function (a, h) {
            var g = h || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]];
            h = g[g.length - 1];
            var p = b[h[0]], m = h[1], d;
            ...
            return {unitRange: p, count: a, unitName: h[0]}
        }
    })(K);
    (function (a) {
        var B = a.Axis, C = a.getMagnitude, E = a.map, F = a.normalizeTickInterval, v = a.pick;
        B.prototype.getLogTickPositions = function (a, q, x, t) {
            var n = this.options, h = this.len, b = this.lin2log, g = this.log2lin, A = [];
            t || (this._minorAutoInterval = null);
            if (.5 <= a)a = Math.round(a), A = this.getLinearTickPositions(a, q, x); else if (.08 <= a)for (var h = Math.floor(q), u, p,
                                                                                                                m, d, r, n = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; h < x + 1 && !r; h++)for (p = n.length, u = 0; u < p && !r; u++)m = g(b(h) * n[u]), m > q && (!t || d <= x) && void 0 !== d && A.push(d), d > x && (r = !0), d = m; else q = b(q), x = b(x), a = n[t ? "minorTickInterval" : "tickInterval"], a = v("auto" === a ? null : a, this._minorAutoInterval, n.tickPixelInterval / (t ? 5 : 1) * (x - q) / ((t ? h / this.tickPositions.length : h) || 1)), a = F(a, null, C(a)), A = E(this.getLinearTickPositions(a, q, x), g), t || (this._minorAutoInterval = a / 5);
    ...
    (function (a) {
        var B = a.dateFormat, C = a.each, E = a.extend, F = a.format, v = a.isNumber, l = a.map, q = a.merge, x = a.pick, t = a.splat, n = a.syncTimeout, h = a.timeUnits;
        a.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        a.Tooltip.prototype = {
            init: function (a, g) {
                ...
                var a = this.chart.renderer, g = this.options;
                ...
                }).css(g.style).shadow(g.shadow)), this.label.attr({zIndex: 8}).add());
                return this.label
            }, update: function (a) {
                this.destroy();
                ...
                var b = this, m = b.now, d = !1 !== b.options.animation && !b.isHidden && (1 < Math.abs(a - m.x) || 1 < Math.abs(g - m.y)), r = b.followPointer || 1 < b.len;
                E(m, {
                    x: d ? (2 * m.x + a) / 3 : a,
                    y: d ? (m.y + g) / 2 : g,
                ...
                var b, h = this.chart, p = h.inverted, m = h.plotTop, d = h.plotLeft, r = 0, G = 0, f, z;
                a = t(a);
                b = a[0].tooltipPos;
                ...
                var b = this.chart, p = this.distance, m = {}, d = h.h || 0, r, G = ["y", b.chartHeight, g, h.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight], f = ["x", b.chartWidth, a, h.plotX +
                b.plotLeft, b.plotLeft, b.plotLeft + b.plotWidth], z = !this.followPointer && x(h.ttBelow, !b.inverted === !!h.negative), e = function (a, c, b, e, f, w) {
                    var k = b < e - p, r = e + p + b < c, D = e - p - b;
                    e += p;
                    if (z && r)m[a] = e; else if (!z && k)m[a] = D; else if (k)m[a] = Math.min(w - b, 0 > D - d ? D : D - d); else if (r)m[a] = Math.max(f, e + d + b > c ? e : e + d); else return !1
                }, y = function (a, c, b, e) {
                    var d;
                ...
                var b = this.chart, h, p = this.options, m, d, r = {}, G = [];
                ...
                }), r = {x: a[0].category, y: a[0].y}, r.points = G, this.len = G.length, a = a[0]);
                r = h.call(r, this);
                f = a.series;
                this.distance = x(f.tooltipOptions.distance, 16);
                !1 === r ? this.hide() : (h = this.getLabel(), this.isHidden && h.attr({opacity: 1}).show(), this.split ? this.renderSplit(r, b.hoverPoints) : (h.attr({text: r && r.join ? r.join("") : r}), h.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" +
                    x(a.colorIndex, f.colorIndex)), h.attr({stroke: p.borderColor || a.color || f.color || "#666666"}), this.updatePosition({
                    plotX: g,
                    plotY: m,
                    negative: a.negative,
                    ttBelow: a.ttBelow,
                ...
                var h = this, u = [], p = this.chart, m = p.renderer, d = !0, r = this.options, G, f = this.getLabel();
                C(b.slice(0, b.length - 1), function (a, b) {
                    b = g[b - 1] || {isHeader: !0, plotX: g[0].plotX};
                    var e = b.series || h, c = e.tt, w = b.series || {}, D = "highcharts-color-" + x(b.colorIndex, w.colorIndex, "none");
                ...
                var b = this.chart, h = this.getLabel(), h = (this.options.positioner ||
                ...
                var p = n && n.closestPointRange, m, d = {
                    millisecond: 15,
                    second: 12,
                    minute: 9,
                    hour: 6,
                ...
                h = a.series;
                var g = h.tooltipOptions, p = g.xDateFormat, m = h.xAxis, d = m && "datetime" === m.options.type && v(a.key), b = g[b + "Format"];
                d && !p && (p = this.getXDateFormat(a, g, m));
                d && p && (b = b.replace("{point.key}", "{point.key:" + p + "}"));
                return F(b, {point: a, series: h})
    ...
    (function (a) {
        var B = a.addEvent, C = a.attr, E = a.charts, F = a.color, v = a.css, l = a.defined, q = a.doc, x = a.each, t = a.extend, n = a.fireEvent, h = a.offset, b = a.pick, g = a.removeEvent, A = a.splat, u = a.Tooltip, p = a.win;
        ...
        a.Pointer.prototype = {
            init: function (a, d) {
                ...
                this.pinchDown = [];
                this.lastValidTouch = {};
                u && d.tooltip.enabled && (a.tooltip = new u(a, d.tooltip), this.followTouchMove = b(d.tooltip.followTouchMove,
                    !0));
                this.setDOMEvents()
            }, zoomOption: function (a) {
                var d = this.chart, m = d.options.chart, p = m.zoomType || "", d = d.inverted;
                ...
                return t(a, {chartX: Math.round(d), chartY: Math.round(b)})
                ...
                var d = this.chart, r = d.series, p = d.tooltip, f = p ? p.shared : !1, h = !0, e = d.hoverPoint, g = d.hoverSeries, c, w, D, u = [], n;
                if (!f && !g)for (c = 0; c < r.length; c++)if (r[c].directTouch || !r[c].options.stickyTracking)r =
                    [];
                g && (f ? g.noSharedTooltip : g.directTouch) && e ? u = [e] : (f || !g || g.options.stickyTracking || (r = [g]), x(r, function (a) {
                    ...
                    var b = a.distX - c.distX, e = a.dist - c.dist, d = c.series.group.zIndex - a.series.group.zIndex;
                    return 0 !== b && f ? b : 0 !== e ? e : 0 !== d ? d : a.series.index > c.series.index ? -1 : 1
                }));
                if (f)for (c = u.length; c--;)(u[c].x !== u[0].x || u[c].series.noSharedTooltip) &&
                u.splice(c, 1);
                ...
                var d = this.chart, m = d.hoverSeries, f = d.hoverPoint, p = d.hoverPoints, e = d.tooltip, h = e && e.shared ? p : f;
                ...
                var b = this.chart, m = b.options.chart, p = a.chartX, f = a.chartY, h = this.zoomHor, e = this.zoomVert, g = b.plotLeft, c = b.plotTop, w = b.plotWidth, D = b.plotHeight, u, n = this.selectionMarker, k = this.mouseDownX, A = this.mouseDownY, l = m.panKey && a[m.panKey + "Key"];
                n && n.touch ||
                (p < g ? p = g : p > g + w && (p = g + w), f < c ? f = c : f > c + D && (f = c + D), this.hasDragged = Math.sqrt(Math.pow(k - p, 2) + Math.pow(A - f, 2)), 10 < this.hasDragged && (u = b.isInsidePlot(k - g, A - c), b.hasCartesianSeries && (this.zoomX || this.zoomY) && u && !l && !n && (this.selectionMarker = n = b.renderer.rect(g, c, h ? 1 : w, e ? 1 : D, 0).attr({
                    ...
                    height: Math.abs(p), y: (0 < p ? 0 : p) +
                    A
                })), u && !n && m.panning && b.pan(a, m.panning)))
            }, drop: function (a) {
                var b = this, m = this.chart, p = this.hasPinched;
                if (this.selectionMarker) {
                    var f = {
                        originalEvent: a,
                        xAxis: [],
                        yAxis: []
                    }, h = this.selectionMarker, e = h.attr ? h.attr("x") : h.x, g = h.attr ? h.attr("y") : h.y, c = h.attr ? h.attr("width") : h.width, w = h.attr ? h.attr("height") : h.height, D;
                    if (this.hasDragged || p)x(m.axes, function (d) {
                        if (d.zoomEnabled && l(d.min) && (p || b[{xAxis: "zoomX", yAxis: "zoomY"}[d.coll]])) {
                            var m = d.horiz, k = "touchend" === a.type ? d.minPixelPadding : 0, r = d.toValue((m ?
                                    e : g) + k), m = d.toValue((m ? e + c : g + w) - k);
                            f[d.coll].push({axis: d, min: Math.min(r, m), max: Math.max(r, m)});
                            D = !0
                        }
            ...
            onDocumentMouseUp: function (b) {
                ...
                var b = this.chart, m = this.chartPosition;
                ...
                var b = this.chart, m = b.hoverPoint, p = b.plotLeft, f = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (m && this.inClass(a.target, "highcharts-tracker") ? (n(m.series, "click", t(a, {point: m})), b.hoverPoint && m.firePointEvent("click", a)) : (t(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX -
    ...
    (function (a) {
        var B = a.charts, C = a.each, E = a.extend, F = a.map, v = a.noop, l = a.pick;
        E(a.Pointer.prototype, {
            pinchTranslate: function (a, l, t, n, h, b) {
                ...
                var u = this.chart, p = a ? "x" : "y", m = a ? "X" : "Y", d = "chart" + m, r = a ? "width" : "height", G = u["plot" + (a ? "Left" : "Top")], f, z, e = A || 1, y = u.inverted, c = u.bounds[a ? "h" : "v"], w = 1 === l.length, D = l[0][d], I = t[0][d], L = !w && l[1][d], k = !w && t[1][d], q;
                t = function () {
                ...
                var q = this, t = q.chart, n = q.pinchDown, h = a.touches, b = h.length, g = q.lastValidTouch, A = q.hasZoom, u = q.selectionMarker, p = {}, m = 1 === b && (q.inClass(a.target, "highcharts-tracker") && t.runTrackerClick || q.runChartClick), d = {};
                1 < b && (q.initiated = !0);
                ...
                "touchstart" === a.type ? (C(h, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = t.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, p = a.toPixels(l(a.options.min, a.dataMin)), e = a.toPixels(l(a.options.max, a.dataMax)), m = Math.max(p, e);
                ...
                var t = this.chart, n, h;
                if (t.index !== a.hoverChartIndex)this.onContainerMouseLeave({relatedTarget: !0});
                a.hoverChartIndex = t.index;
                1 === q.touches.length ? (q = this.normalize(q), (h = t.isInsidePlot(q.chartX - t.plotLeft, q.chartY - t.plotTop)) && !t.openMenu ? (v && this.runPointActions(q), "touchmove" === q.type && (v = this.pinchDown, n = v[0] ? 4 <= Math.sqrt(Math.pow(v[0].chartX - q.chartX, 2) + Math.pow(v[0].chartY - q.chartY, 2)) : !1), l(n,
                    !0) && this.pinch(q)) : v && this.reset()) : 2 === q.touches.length && this.pinch(q)
    ...
    (function (a) {
        var B = a.addEvent, C = a.charts, E = a.css, F = a.doc, v = a.extend, l = a.noop, q = a.Pointer, x = a.removeEvent, t = a.win, n = a.wrap;
        if (t.PointerEvent || t.MSPointerEvent) {
            var h = {}, b = !!t.PointerEvent, g = function () {
                var a, b = [];
                b.item = function (a) {
                    return this[a]
                };
    ...
    (function (a) {
        var B, C = a.addEvent, E = a.css, F = a.discardElement, v = a.defined, l = a.each, q = a.extend, x = a.isFirefox, t = a.marginNames,
            n = a.merge, h = a.pick, b = a.setAnimation, g = a.stableSort, A = a.win, u = a.wrap;
        ...
        B.prototype = {
            init: function (a, b) {
                ...
                var d = this.options, m = a.legendItem, h = a.legendLine, f = a.legendSymbol, p = this.itemHiddenStyle.color, d = b ? d.itemStyle.color : p, e = b ? a.color || p : p, g = a.options && a.options.marker,
                    c = {fill: e}, w;
                m && m.css({fill: d, color: d});
                h && h.attr({stroke: e});
                if (f) {
                    if (g && f.isMarker && (c = a.pointAttribs(), !b))for (w in c)c[w] = p;
                    f.attr(c)
                }
            }, positionItem: function (a) {
                var b = this.options, d = b.symbolPadding, b = !b.rtl, h = a._legendItemPos, p = h[0], h = h[1], f = a.checkbox;
            ...
            destroy: function () {
                ...
                var b = this.group && this.group.alignAttr, d, h = this.clipHeight || this.legendHeight, g = this.titleHeight;
            ...
            renderTitle: function () {
                ...
                var h = this.options;
                b.legendItem.attr({text: h.labelFormat ? a.format(h.labelFormat, b) : h.labelFormatter.call(b)})
            }, renderItem: function (a) {
                var b =
                    this.chart, d = b.renderer, g = this.options, p = "horizontal" === g.layout, f = this.symbolWidth, u = g.symbolPadding, e = this.itemStyle, y = this.itemHiddenStyle, c = this.padding, w = p ? h(g.itemDistance, 20) : 0, D = !g.rtl, I = g.width, A = g.itemMarginBottom || 0, k = this.itemMarginTop, l = this.initialItemX, q = a.legendItem, t = !a.series, v = !t && a.series.drawLegendSymbol ? a.series : a, x = v.options, x = this.createCheckboxForItem && x && x.showCheckbox, J = g.useHTML;
                q || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + v.type + "-series highcharts-color-" +
                    a.colorIndex + (a.options.className ? " " + a.options.className : "") + (t ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = q = d.text("", D ? f + u : -u, this.baseline || 0, J).css(n(a.visible ? e : y)).attr({
                    align: D ? "left" : "right",
                    zIndex: 2
                ...
                var d = this.chart, g = this.options, m = g.align.charAt(0) + g.verticalAlign.charAt(0) + g.layout.charAt(0);
                g.floating || l([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/,
                    /(lbv|lm|ltv)/], function (f, p) {
                    f.test(m) && !v(a[p]) && (d[t[p]] = Math.max(d[t[p]], d.legend[(p + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][p] * g[p % 2 ? "x" : "y"] + h(g.margin, 12) + b[p]))
                })
            }, render: function () {
                var a = this, b = a.chart, d = b.renderer, h = a.group, u, f, n, e, y = a.box, c = a.options, w = a.padding;
                a.itemX = a.initialItemX;
                a.itemY = a.initialItemY;
                a.offsetWidth = 0;
                a.lastItemY = 0;
                h || (a.group = h = d.g("legend").attr({zIndex: 7}).add(), a.contentGroup = d.g().attr({zIndex: 1}).add(h), a.scrollGroup = d.g().add(a.contentGroup));
                a.renderTitle();
                u = a.getAllItems();
                g(u, function (a, b) {
                ...
                e += w;
                y || (a.box = y = d.rect().addClass("highcharts-legend-box").attr({r: c.borderRadius}).add(h), y.isNew = !0);
                y.attr({
                ...
                f && h.align(q({width: n, height: e}, c), !0, "spacingBox");
                b.isResizing || this.positionCheckboxes()
            }, handleOverflow: function (a) {
                var b = this, d = this.chart, g = d.renderer, p = this.options, f = p.y, d = d.spacingBox.height + ("top" === p.verticalAlign ? -f : f) - this.padding, f = p.maxHeight, u, e = this.clipRect, y = p.navigation,
                    c = h(y.animation, !0), w = y.arrowSize || 12, D = this.nav, n = this.pages, A = this.padding, k, q = this.allItems, t = function (a) {
                        a ? e.attr({height: a}) : e && (b.clipRect = e.destroy(), b.contentGroup.clip());
                ...
                a > d && !1 !== y.enabled ? (this.clipHeight = u = Math.max(d - 20 - this.titleHeight - A, 0), this.currentPage = h(this.currentPage, 1), this.fullHeight =
                    ...
                    this.down = g.symbol("triangle-down", 0, 0, w, w).on("click", function () {
                        b.scroll(1, c)
                    }).add(D)), b.scroll(0), a = d) : D && (t(), D.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            }, scroll: function (a, h) {
                var d = this.pages, g = d.length;
                a = this.currentPage + a;
                var m = this.clipHeight, f = this.options.navigation, p = this.pager, e = this.padding;
                a > g && (a = g);
                ...
                }), p.attr({text: a + "/" + g}), this.down.attr({
                    x: 18 + this.pager.getBBox().width,
                    "class": a === g ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                }), this.up.attr({fill: 1 === a ? f.inactiveColor : f.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === g ? f.inactiveColor : f.activeColor}).css({cursor: a === g ? "default" : "pointer"}), h = -d[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: h}), this.currentPage =
                    a, this.positionCheckboxes(h))
            }
        };
        a.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                var d = a.options, g = d.symbolHeight || a.fontMetrics.f, d = d.squareSymbol;
                b.legendSymbol = this.chart.renderer.rect(d ? (a.symbolWidth - g) / 2 : 0, a.baseline - g + 1, d ? g : a.symbolWidth, g, h(a.options.symbolRadius, g / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(b.legendGroup)
            }, drawLineMarker: function (a) {
                var b = this.options, d = b.marker, h = a.symbolWidth, g = this.chart.renderer, f = this.legendGroup;
    ...
    (function (a) {
        ...
        N.prototype = {
            callbacks: [], getArgs: function () {
                ...
                var c = this.axes, e = this.series, d = this.pointer, k = this.legend, f = this.isDirtyLegend,
                    w, h, D = this.hasCartesianSeries, m = this.isDirtyBox, u = e.length, r = u, y = this.renderer, n = y.isHidden(), z = [];
                a.setAnimation(b, this);
                n && this.cloneRenderTo();
                for (this.layOutTitles(); r--;)if (b = e[r], b.options.stacking && (w = !0, b.isDirty)) {
                    h = !0;
                    break
                }
                if (h)for (r = u; r--;)b = e[r], b.options.stacking && (b.isDirty = !0);
                g(e, function (a) {
                ...
                var e = this, d = e.options, k;
                k = d.title = y({style: {color: "#333333", fontSize: d.isStock ? "16px" : "18px"}}, d.title, a);
                d = d.subtitle = y({style: {color: "#666666"}}, d.subtitle, b);
                g([["title", a, k], ["subtitle", b, d]], function (a, b) {
                    var c = a[0], d = e[c], k = a[1];
                    a = a[2];
                    d && k && (e[c] = d = d.destroy());
                ...
                var b = 0, c, e = this.renderer, d = this.spacingBox;
                g(["title", "subtitle"], function (a) {
                    var c = this[a], k = this.options[a], f;
                    c && (f = k.style.fontSize, f = e.fontMetrics(f, c).b, c.css({width: (k.width || d.width + k.widthAdjust) + "px"}).align(A({y: b + f + ("title" === a ? -3 : 2)}, k), !1, "spacingBox"), k.floating || k.verticalAlign || (b = Math.ceil(b + c.getBBox().height)))
                }, this);
                ...
                var a = this.options.chart, c = a.width, a = a.height, e = this.renderToClone || this.renderTo;
                b(c) || (this.containerWidth = m(e, "width"));
                b(a) || (this.containerHeight = m(e, "height"));
                this.chartWidth = Math.max(0, c || this.containerWidth || 600);
                this.chartHeight = Math.max(0, w(a, 19 < this.containerHeight ? this.containerHeight : 350))
                ...
                var b, c = this.options, e = c.chart, d, k;
                b = this.renderTo;
                var w = a.uniqueKey(), h;
                b ||
                ...
                this.container = b = q("div", {id: w}, h, this.renderToClone || b);
                ...
                var c = this, e = c.options.chart, d = c.renderTo, k = b(e.width), f = e.width || m(d, "width"), e = e.height || m(d, "height"), d = a ? a.target : M;
                if (!k && !c.isPrinting && f && e && (d === M || d === v)) {
                ...
                var b =
                    this.inverted, c = this.renderer, e = this.chartWidth, d = this.chartHeight, k = this.options.chart, f = this.spacing, w = this.clipOffset, h, D, m, u;
                ...
                this.spacingBox = c.spacingBox = {x: f[3], y: f[0], width: e - f[3] - f[1], height: d - f[0] - f[2]};
                this.plotBox = c.plotBox = {x: h, y: D, width: m, height: u};
                ...
                d[l]({x: u / 2, y: u / 2, width: c - u - w % 2, height: e - u - w % 2, r: a.borderRadius});
                l = "animate";
                k || (l = "attr", this.plotBackground = k = b.rect().addClass("highcharts-plot-background").add());
                k[l](z);
                k.attr({fill: D || "none"}).shadow(a.plotShadow);
                m && (h ? h.animate(z) :
                    this.plotBGImage = b.image(m, r, p, y, n).add());
                A ? A.animate({width: I.width, height: I.height}) : this.clipRect = b.clipRect(I);
                l = "animate";
                f || (l = "attr", this.plotBorder = f = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                f.attr({stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none"});
                f[l](f.crisp({x: r, y: p, width: y, height: n}, -f.strokeWidth()));
                this.isDirtyBox = !1
                ...
                b.items && g(b.items, function (c) {
                    var e = A(b.style, c.style), d = D(e.left) + a.plotLeft, k = D(e.top) + a.plotTop + 12;
                    delete e.left;
                    delete e.top;
                    a.renderer.text(c.html, d, k).attr({zIndex: 2}).css(e).add()
                })
            }, render: function () {
                ...
                var b = this, c = b.axes, e = b.series, d = b.container, k, f = d && d.parentNode;
                p(b, "destroy");
                n[b.index] = void 0;
                a.chartCount--;
    ...
    (function (a) {
        var B, C = a.each, E = a.extend, F = a.erase, v = a.fireEvent, l = a.format, q = a.isArray, x = a.isNumber, t = a.pick, n = a.removeEvent;
        B = a.Point = function () {
        };
        B.prototype = {
            init: function (a, b, g) {
                ...
                var g = this.series, h = g.options.pointValKey || g.pointValKey;
                ...
                var b = {}, g = this.series, h = g.options.keys, u = h || g.pointArrayMap || ["y"], p = u.length, m = 0, d = 0;
                if (x(a) || null === a)b[u[0]] = a; else if (q(a))for (!h && a.length > p && (g = typeof a[0], "string" === g ? b.name = a[0] : "number" === g && (b.x = a[0]), m++); d < p;)h && void 0 ===
                a[m] || (b[u[d]] = a[m]), m++, d++; else"object" === typeof a && (b = a, a.dataLabels && (g._hasPointLabels = !0), a.marker && (g._hasPointMarkers = !0));
                return b
            ...
            getZone: function () {
                var a = this.series, b = a.zones, a = a.zoneAxis || "y", g = 0, n;
                for (n = b[g]; this[a] >= n.value;)n = b[++g];
                n && n.color && !this.options.color && (this.color = n.color);
                return n
            }, destroy: function () {
                var a = this.series.chart, b = a.hoverPoints, g;
                a.pointCount--;
                ...
                for (var a =
                    ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], b, g = 6; g--;)b = a[g], this[b] && (this[b] = this[b].destroy())
                ...
                var b = this.series, g = b.tooltipOptions, h = t(g.valueDecimals, ""), u = g.valuePrefix || "", p = g.valueSuffix || "";
                ...
                var h = this, u = this.series.options;
    ...
    (function (a) {
        var B = a.addEvent, C = a.animObject, E = a.arrayMax, F = a.arrayMin, v = a.correctFloat,
            l = a.Date, q = a.defaultOptions, x = a.defaultPlotOptions, t = a.defined, n = a.each, h = a.erase, b = a.extend, g = a.fireEvent, A = a.grep, u = a.isArray, p = a.isNumber, m = a.isString, d = a.merge, r = a.pick, G = a.removeEvent, f = a.splat, z = a.SVGElement, e = a.syncTimeout, y = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            coll: "series",
            init: function (a, e) {
                var c = this, d, f, k = a.series, w;
                c.chart = a;
                c.options = e = c.setOptions(e);
                c.linkedSeries = [];
                c.bindAxes();
                b(c, {name: e.name, state: "", visible: !1 !== e.visible, selected: !0 === e.selected});
                f = e.events;
            ...
            bindAxes: function () {
                var b = this, e = b.options, d = b.chart, f;
            ...
            autoIncrement: function () {
                var a = this.options, b = this.xIncrement, e, d = a.pointIntervalUnit,
            ...
            getCyclic: function (a, b, e) {
                var c, d = this.userOptions,
                    k = a + "Index", f = a + "Counter", w = e ? e.length : r(this.chart.options.chart[a + "Count"], this.chart[a + "Count"]);
            ...
            setData: function (b, e, d, f) {
                var c = this, k = c.points, w = k && k.length || 0, g, h = c.options, D = c.chart, y = null, z = c.xAxis, l = h.turboThreshold, A = this.xData, I = this.yData, G = (g = c.pointArrayMap) && g.length;
                b = b || [];
                g = b.length;
                e = r(e, !0);
                if (!1 !== f && g && w === g && !c.cropped && !c.hasGroupedData && c.visible)n(b, function (a, b) {
                    ...
                    if (l && g > l) {
                        ...
                        if (p(y))for (d =
                                          0; d < g; d++)A[d] = this.autoIncrement(), I[d] = b[d]; else if (u(y))if (G)for (d = 0; d < g; d++)y = b[d], A[d] = y[0], I[d] = y.slice(1, G + 1); else for (d = 0; d < g; d++)y = b[d], A[d] = y[0], I[d] = y[1]; else a.error(12)
                    } else for (d = 0; d < g; d++)void 0 !== b[d] && (y = {series: c}, c.pointClass.prototype.applyOptions.apply(y, [b[d]]), c.updateParallelArrays(y, d));
                    m(I[0]) && a.error(14, !0);
                    c.data = [];
            ...
            processData: function (b) {
                ...
                f = 0;
                var k, g, h = this.xAxis, m, u = this.options;
                m = u.cropThreshold;
                var r = this.getExtremesFromAll || u.getExtremesFromAll, p = this.isCartesian, u = h && h.val2lin, y = h && h.isLog, n, z;
                if (p && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !b)return !1;
                h && (b = h.getExtremes(), n = b.min, z = b.max);
                if (p && this.sorted && !r && (!m || d > m || this.forceCrop))if (c[d - 1] < n || c[0] > z)c = [],
                    e = []; else if (c[0] < n || c[d - 1] > z)f = this.cropData(this.xData, this.yData, n, z), c = f.xData, e = f.yData, f = f.start, k = !0;
            ...
            cropData: function (a, b, e, d) {
                var c = a.length, k = 0, f = c, w = r(this.cropShoulder, 1), g;
                for (g = 0; g < c; g++)if (a[g] >= e) {
                    k = Math.max(0, g - w);
                    break
                }
                for (e = g; e < c; e++)if (a[e] > d) {
                    f = e + w;
                    break
                }
                return {
                    xData: a.slice(k,
                        f), yData: b.slice(k, f), start: k, end: f
                }
            },
            generatePoints: function () {
                var a = this.options.data, b = this.data, e, d = this.processedXData, g = this.processedYData, k = this.pointClass, h = d.length, m = this.cropStart || 0, u, r = this.hasGroupedData, p, y = [], n;
                ...
                if (b && (h !== (e = b.length) || r))for (n = 0; n < e; n++)n !== m ||
                r || (n += h), b[n] && (b[n].destroyElements(), b[n].plotX = void 0);
                this.data = b;
                this.points = y
            },
            getExtremes: function (a) {
                var b = this.yAxis, c = this.processedXData, e, d = [], k = 0;
                e = this.xAxis.getExtremes();
                var f = e.min, g = e.max, h, m, r, n;
                a = a || this.stackedYData || this.processedYData || [];
                e = a.length;
                for (n = 0; n < e; n++)if (m = c[n], r = a[n], h = (p(r, !0) || u(r)) && (!b.isLog || r.length || 0 < r), m = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[n + 1] || m) >= f && (c[n - 1] || m) <= g, h && m)if (h = r.length)for (; h--;)null !== r[h] && (d[k++] =
                    r[h]); else d[k++] = r;
                this.dataMin = F(d);
                this.dataMax = E(d)
            },
            translate: function () {
                ...
                this.generatePoints();
                var a = this.options, b = a.stacking, e = this.xAxis, d = e.categories, f = this.yAxis, k = this.points, g = k.length, h = !!this.modifyValue, m = a.pointPlacement, u = "between" === m || p(m), n = a.threshold, y = a.startFromThreshold ? n : 0, z, l, A, G, q = Number.MAX_VALUE;
                "between" === m && (m = .5);
                p(m) && (m *= r(a.pointRange || e.pointRange));
                for (a = 0; a < g; a++) {
                    var x = k[a], C = x.x, B = x.y;
                    l = x.low;
                    var E = b && f.stacks[(this.negStacks &&
                        B < (y ? 0 : n) ? "-" : "") + this.stackKey], F;
            ...
            setClip: function (a) {
                var b = this.chart, c = this.options, e = b.renderer, d = b.inverted, f = this.clipBox, g = f || b.clipBox, h = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, g.height, c.xAxis, c.yAxis].join(), m = b[h], u = b[h + "m"];
                m || (a && (g.width = 0, b[h + "m"] = u = e.clipRect(-99, d ? -b.plotLeft : -b.plotTop, 99, d ? b.chartWidth : b.chartHeight)), b[h] = m = e.clipRect(g), m.count = {length: 0});
            ...
            drawPoints: function () {
                var a = this.points, b = this.chart, e, d, f, k, g = this.options.marker, h, m, u, n, y = this.markerGroup, z = r(g.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx > 2 * g.radius);
                if (!1 !== g.enabled || this._hasPointMarkers)for (d = a.length; d--;)f = a[d], e = f.plotY, k = f.graphic, h = f.marker || {}, m = !!f.marker, u = z && void 0 === h.enabled || h.enabled, n = f.isInside, u && p(e) && null !== f.y ? (e = r(h.symbol, this.symbol), f.hasImage = 0 === e.indexOf("url"), u = this.markerAttribs(f, f.selected && "select"),
            ...
            markerAttribs: function (a, b) {
                var c = this.options.marker, e = a && a.options, d = e && e.marker || {}, e = r(d.radius, c.radius);
            ...
            pointAttribs: function (a, b) {
                var c = this.options.marker, e = a && a.options, d = e && e.marker || {}, f = this.color, g = e && e.color, h = a && a.color, e = r(d.lineWidth, c.lineWidth);
                ...
                return {
                    stroke: f, "stroke-width": e,
                    fill: a
                }
            },
            destroy: function () {
                var a = this, b = a.chart, e = /AppleWebKit\/533/.test(y.navigator.userAgent), d, f = a.data || [], k, m, u;
                g(a, "destroy");
                G(a);
            ...
            getGraphPath: function (a, b, e) {
                ...
                n(a, function (k, g) {
                    ...
                    k.isNull && !t(b) && 0 < g ? m = !d.connectNulls : k.isNull && !b ? m = !0 : (0 === g || m ? g = ["M", k.plotX, k.plotY] : c.getPointSpline ? g = c.getPointSpline(a, k, g) : f ? (g = 1 === f ? ["L", p.plotX,
                        r] : 2 === f ? ["L", (p.plotX + u) / 2, p.plotY, "L", (p.plotX + u) / 2, r] : ["L", u, p.plotY], g.push("L", u, r)) : g = ["L", u, r], w.push(k.x), f && w.push(k.x), h.push.apply(h, g), m = !1)
                });
                h.xMap = w;
                return c.graphPath = h
            },
            drawGraph: function () {
                var a = this, b = this.options, e = (this.gappedPath || this.getGraphPath).call(this), d = [["graph", "highcharts-graph", b.lineColor || this.color, b.dashStyle]];
                ...
                n(d, function (c, d) {
                    var f = c[0], k = a[f];
                    k ? (k.endX = e.xMap, k.animate({d: e})) : e.length && (a[f] = a.chart.renderer.path(e).addClass(c[1]).attr({zIndex: 1}).add(a.group), k = {
                        stroke: c[2],
            ...
            applyZones: function () {
                var a = this, b = this.chart, e = b.renderer, d = this.zones, f, k, g = this.clips || [],
                    h, m = this.graph, u = this.area, p = Math.max(b.chartWidth, b.chartHeight), y = this[(this.zoneAxis || "y") + "Axis"], z, l, A = b.inverted, G, q, t, v, x = !1;
            ...
            plotGroup: function (a, b, e, d, f) {
                var c = this[a], g = !c;
                g && (this[a] = c = this.chart.renderer.g(b).attr({zIndex: d || .1}).add(f), c.addClass("highcharts-series-" + this.index + " highcharts-" + this.type + "-series highcharts-color-" + this.colorIndex + " " + (this.options.className || "")));
                c.attr({visibility: e})[g ? "attr" : "animate"](this.getPlotBox());
                return c
            },
            getPlotBox: function () {
                var a = this.chart, b = this.xAxis, e =
                    this.yAxis;
                a.inverted && (b = e, e = this.xAxis);
                return {translateX: b ? b.left : a.plotLeft, translateY: e ? e.top : a.plotTop, scaleX: 1, scaleY: 1}
            },
            render: function () {
                var a = this, b = a.chart, d, f = a.options, g = !!a.animate && b.renderer.isSVG && C(f.animation).duration, k = a.visible ? "inherit" : "hidden", h = f.zIndex, m = a.hasRendered, u = b.seriesGroup, r = b.inverted;
            ...
            redraw: function () {
                ...
                e && (a.inverted && e.attr({width: a.plotWidth, height: a.plotHeight}), e.animate({
                    translateX: r(d &&
                        d.left, a.plotLeft), translateY: r(f && f.top, a.plotTop)
                }));
                this.translate();
                this.render();
            ...
            buildKDTree: function () {
                function a(c, e, d) {
                    ...
                    if (k = c && c.length)return f = b.kdAxisArray[e % d], c.sort(function (a, b) {
                        ...
                        2), {point: c[k], left: a(c.slice(0, k), e + 1, d), right: a(c.slice(k + 1), e + 1, d)}
                }
            ...
            searchKDTree: function (a, b) {
                function c(a, b, k, h) {
                    var m = b.point, u = e.kdAxisArray[k % h], w, r, p = m;
                ...
                var e = this, d = this.kdAxisArray[0], f = this.kdAxisArray[1], g = b ? "distX" : "dist";
    ...
    (function (a) {
        ...
        var C = a.Axis, E = a.Chart, F = a.correctFloat, v = a.defined, l = a.destroyObjectProperties, q = a.each, x = a.format, t = a.pick;
        a = a.Series;
        B.prototype = {
            destroy: function () {
                l(this, this.axis)
            }, render: function (a) {
                var h = this.options, b = h.format, b = b ? x(b, this) : h.formatter.call(this);
                this.label ?
                    this.label.attr({
                        text: b,
                        visibility: "hidden"
                ...
                var b = this.axis, g = b.chart, n = g.inverted, u = b.reversed, u = this.isNegative && !u || !this.isNegative && u, p = b.translate(b.usePercentage ? 100 : this.total, 0, 0, 0, 1), b = b.translate(0), b = Math.abs(p - b);
                a = g.xAxis[0].translate(this.x) + a;
                var m = g.plotHeight, n = {
                    x: n ? u ? p : p - b : a, y: n ? m - a - h : u ? m - p - b : m - p, width: n ?
                        b : h, height: n ? h : b
                };
        ...
        C.prototype.buildStacks = function () {
            ...
            if (!this.isXAxis) {
                ...
                if (this.usePercentage)for (l = 0; l < g; l++)a[l].setPercentStacks()
            }
        };
        C.prototype.renderStackTotals = function () {
            var a = this.chart, h = a.renderer, b = this.stacks, g, l, u = this.stackTotalGroup;
            u || (this.stackTotalGroup = u = h.g("stack-labels").attr({visibility: "visible", zIndex: 6}).add());
            u.translate(a.plotLeft, a.plotTop);
            for (g in b)for (l in a = b[g], a)a[l].render(u)
        };
        C.prototype.resetStacks = function () {
            var a = this.stacks, h, b;
            if (!this.isXAxis)for (h in a)for (b in a[h])a[h][b].touched < this.stacksTouched ? (a[h][b].destroy(), delete a[h][b]) : (a[h][b].total = null, a[h][b].cum = null)
        };
        C.prototype.cleanStacks = function () {
            var a, h, b;
            if (!this.isXAxis)for (h in this.oldStacks && (a = this.stacks = this.oldStacks), a)for (b in a[h])a[h][b].cum = a[h][b].total
        };
        a.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var a =
                    this.processedXData, h = this.processedYData, b = [], g = h.length, l = this.options, u = l.threshold, p = l.startFromThreshold ? u : 0, m = l.stack, l = l.stacking, d = this.stackKey, r = "-" + d, G = this.negStacks, f = this.yAxis, z = f.stacks, e = f.oldStacks, y, c, w, D, q, x, k;
                f.stacksTouched += 1;
        ...
        a.prototype.setPercentStacks =
            function () {
                var a = this, h = a.stackKey, b = a.yAxis.stacks, g = a.processedXData, l;
                q([h, "-" + h], function (h) {
                    for (var u = g.length, m, d; u--;)if (m = g[u], l = a.getStackIndicator(l, m, a.index, h), m = (d = b[h] && b[h][m]) && d.points[l.key])d = d.total ? 100 / d.total : 0, m[0] = F(m[0] * d), m[1] = F(m[1] * d), a.stackedYData[u] = m[1]
                })
            };
        a.prototype.getStackIndicator = function (a, h, b, g) {
            !v(a) || a.x !== h || g && a.key !== g ? a = {x: h, index: 0, key: g} : a.index++;
            a.key = [b, h, a.index].join();
            return a
        }
    })(K);
    (function (a) {
        var B = a.addEvent, C = a.animate, E = a.Axis, F = a.createElement,
            v = a.css, l = a.defined, q = a.each, x = a.erase, t = a.extend, n = a.fireEvent, h = a.inArray, b = a.isNumber, g = a.isObject, A = a.merge, u = a.pick, p = a.Point, m = a.Series, d = a.seriesTypes, r = a.setAnimation, G = a.splat;
        t(a.Chart.prototype, {
            addSeries: function (a, b, e) {
                var d, c = this;
                a && (b = u(b, !0), n(c, "addSeries", {options: a}, function () {
                    d = c.initSeries(a);
                    c.isDirtyLegend = !0;
                    c.linkSeries();
                    b && c.redraw(e)
            ...
            addAxis: function (a, b, e, d) {
                ...
                a = A(a, {index: this[c].length, isX: b});
                new E(this, a);
                f[c] = G(f[c] ||
                    {});
                f[c].push(a);
            ...
            showLoading: function (a) {
                var b = this, e = b.options, d = b.loadingDiv, c = e.loading, f = function () {
                    d && v(d, {
                        left: b.plotLeft + "px",
                        top: b.plotTop + "px",
                ...
                d || (b.loadingDiv = d = F("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = F("span", {className: "highcharts-loading-inner"}, null, d), B(b, "redraw", f));
                ...
                b.loadingShown || (v(d, {
                    opacity: 0,
                    display: ""
                }), C(d, {opacity: c.style.opacity || .5}, {duration: c.showDuration || 0}));
                b.loadingShown = !0;
                f()
            },
            ...
            update: function (a, d) {
                var e, f = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, c = a.chart, g, m;
                if (c) {
        ...
        t(p.prototype, {
            update: function (a, b, e, d) {
                ...
                var f = this, h = f.series, m = f.graphic, r, k = h.chart, p = h.options;
                b = u(b, !0);
                !1 === d ? c() : f.firePointEvent("update", {options: a}, c)
            }, remove: function (a, b) {
        ...
        t(m.prototype, {
            addPoint: function (a,
                                b, e, d) {
                var c = this.options, f = this.data, g = this.chart, h = this.xAxis && this.xAxis.names, m = c.data, k, r, p = this.xData, y, l;
                b = u(b, !0);
                k = {series: this};
                this.pointClass.prototype.applyOptions.apply(k, [a]);
                l = k.x;
                y = p.length;
                if (this.requireSorting && l < p[y - 1])for (r = !0; y && p[y - 1] > l;)y--;
                ...
                var d = this, c = d.data, f = c[a], g = d.points, h = d.chart, m = function () {
                ...
                var e = this, f = this.chart, c = this.userOptions, g = this.type, h = a.type || c.type || f.options.chart.type, m = d[g].prototype, r = ["group", "markerGroup", "dataLabelsGroup"], k;
                if (h && h !== g || void 0 !== a.zIndex)r.length = 0;
                q(r, function (a) {
                    r[a] = e[a];
                    delete e[a]
                });
                a = A(c, {animation: !1, index: this.index, pointStart: this.xData[0]}, {data: this.options.data}, a);
                this.remove(!1, null, !1);
                for (k in m)this[k] = void 0;
    ...
    (function (a) {
        var B = a.color, C = a.each, E = a.map, F = a.pick, v = a.Series, l = a.seriesType;
        l("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function () {
                var a = [], l = [], t = this.xAxis, n = this.yAxis, h = n.stacks[this.stackKey], b = {}, g = this.points, A = this.index, u = n.series, p = u.length, m, d = F(n.options.reversedStacks,
                    !0) ? 1 : -1, r, G;
                if (this.options.stacking) {
                    ...
                    C(l, function (f, g) {
                        ...
                        if (b[f] && !b[f].isNull)a.push(b[f]), C([-1, 1], function (a) {
                            var e = 1 === a ? "rightNull" : "leftNull", w = 0, n = h[l[g + a]];
                            if (n)for (r = A; 0 <= r && r < p;)u = n.points[r], u || (r === A ? b[f][e] = !0 : m[r] && (c = h[f].points[r]) && (w -= c[1] - c[0])), r += d;
                            ...
                            e = n.toPixels(e, !0);
                            a.push({isNull: !0, plotX: t.toPixels(f, !0), plotY: e, yBottom: e})
                        }
                    })
                }
                return a
            }, getGraphPath: function (a) {
                var l = v.prototype.getGraphPath, q = this.options, n = q.stacking, h = this.yAxis, b, g, A = [], u = [], p = this.index, m, d = h.stacks[this.stackKey], r = q.threshold, G = h.getThreshold(q.threshold), f, q = q.connectNulls || "percent" === n, z = function (b, f, c) {
                    var e = a[b];
                    b = n && d[e.x].points[p];
                    var g = e[c + "Null"] || 0;
                    c = e[c + "Cliff"] || 0;
                    ...
                    void 0 !== l && (u.push({
                        ...
                        isNull: e
                    }), A.push({plotX: m, plotY: null === y ? G : h.getThreshold(y), doCurve: !1}))
                };
                a = a || this.points;
                n && (a = this.getStackPoints());
                for (b = 0; b < a.length; b++)if (g = a[b].isNull, m = F(a[b].rectPlotX, a[b].plotX), f = F(a[b].yBottom, G), !g || q)q || z(b, b - 1, "left"), g && !n && q || (u.push(a[b]), A.push({
                    x: b,
                    plotX: m,
                    plotY: f
                })), q || z(b, b + 1, "right");
                ...
                var a = this, l = this.areaPath, t = this.options, n = [["area", "highcharts-area", this.color, t.fillColor]];
                ...
                C(n, function (h) {
                    var b = h[0], g = a[b];
                    g ? (g.endX = l.xMap, g.animate({d: l})) : (g = a[b] = a.chart.renderer.path(l).addClass(h[1]).attr({
                        fill: F(h[3],
                            B(h[2]).setOpacity(F(t.fillOpacity, .75)).get()), zIndex: 0
    ...
    (function (a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function (a, E, F) {
                var v = E.plotX, l = E.plotY, q = a[F - 1];
                F = a[F + 1];
                var x, t, n, h;
    ...
    (function (a) {
        var B = a.animObject, C = a.color, E = a.each, F = a.extend, v = a.isNumber, l = a.merge, q = a.pick, x = a.Series, t = a.seriesType, n = a.svg;
        t("column", "line", {
            borderRadius: 0,
            groupPadding: .2,
            marker: null,
            ...
            getColumnMetrics: function () {
                var a = this, b = a.options, g = a.xAxis, l = a.yAxis, u = g.reversed, p, m = {}, d = 0;
                ...
                var r = Math.min(Math.abs(g.transA) * (g.ordinalSlope || b.pointRange || g.closestPointRange || g.tickInterval || 1), g.len), n = r * b.groupPadding, f = (r - 2 * n) / d, b = Math.min(b.maxPointWidth || g.len, q(b.pointWidth, f * (1 - 2 * b.pointPadding)));
                a.columnMetrics = {
                    width: b,
            ...
            crispCol: function (a, b, g, l) {
                var h = this.chart, p = this.borderWidth, m = -(p % 2 ? .5 : 0), p = p % 2 ? .5 : 1;
                ...
                l -= b;
                m && l && (--b, l += 1);
                return {x: a, y: b, width: g - a, height: l}
            },
            translate: function () {
                var a = this, b = a.chart, g = a.options, l = a.dense = 2 > a.closestPointRange * a.xAxis.transA, l = a.borderWidth = q(g.borderWidth, l ? 0 : 1), u = a.yAxis, p = a.translatedThreshold = u.getThreshold(g.threshold), m = q(g.minPointLength,
                    5), d = a.getColumnMetrics(), r = d.width, n = a.barW = Math.max(r, 1 + 2 * l), f = a.pointXOffset = d.offset;
                b.inverted && (p -= .5);
                g.pointPadding && (n = Math.ceil(n));
                x.prototype.translate.apply(a);
                E(a.points, function (d) {
                    var e = q(d.yBottom, p), g = 999 + Math.abs(e), g = Math.min(Math.max(-g, d.plotY), u.len + g), c = d.plotX + f, h = n, l = Math.min(g, e), G, z = Math.max(g, e) - l;
                    ...
                    g, a.xAxis.len - c - h / 2, z] : [c + h / 2, g + u.pos - b.plotTop, z];
                    d.shapeType = "rect";
            ...
            pointAttribs: function (a, b) {
                var g = this.options, h, u = this.pointAttrToOptions || {};
                h = u.stroke || "borderColor";
                var p = u["stroke-width"] || "borderWidth", m = a && a.color || this.color, d = a[h] || g[h] || this.color ||
                ...
                h = {fill: m, stroke: d, "stroke-width": r};
                g.borderRadius && (h.r = g.borderRadius);
                u && (h.dashstyle = u);
                return h
            },
            drawPoints: function () {
                var a = this, b = this.chart, g = a.options, n = b.renderer, u = g.animationLimit || 250, p;
                E(a.points, function (m) {
                    var d = m.graphic;
                    if (v(m.plotY) &&
                        null !== m.y) {
                        p = m.shapeArgs;
                        if (d)d[b.pointCount < u ? "animate" : "attr"](l(p)); else m.graphic = d = n[m.shapeType](p).attr({"class": m.getClassName()}).add(m.group || a.group);
                        d.attr(a.pointAttribs(m, m.selected && "select")).shadow(g.shadow, null, g.stacking && !g.borderRadius)
                    } else d && (m.graphic = d.destroy())
                })
            },
            animate: function (a) {
                var b = this, g = this.yAxis, h = b.options, u = this.chart.inverted, p = {};
    ...
    (function (a) {
        var B = a.pick, C = a.relativeLength;
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, F = this.chart, v = 2 * (a.slicedOffset || 0), l = F.plotWidth - 2 * v, F = F.plotHeight -
                    2 * v, q = a.center, q = [B(q[0], "50%"), B(q[1], "50%"), a.size || "100%", a.innerSize || 0], x = Math.min(l, F), t, n;
    ...
    (function (a) {
        var B = a.addEvent, C = a.defined, E = a.each, F = a.extend, v = a.inArray, l = a.noop, q = a.pick, x = a.Point, t = a.Series, n = a.seriesType, h = a.setAnimation;
        n("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            animate: function (a) {
                var b = this, h = b.points, u = b.startAngleRad;
                a || (E(h, function (a) {
                    var g =
                        a.graphic, d = a.shapeArgs;
                    g && (g.attr({r: a.startR || b.center[3] / 2, start: u, end: u}), g.animate({
                        r: d.r,
                        start: d.start,
                        end: d.end
                    }, b.options.animation))
            ...
            updateTotals: function () {
                var a, g = 0, h = this.points, u = h.length, p, m = this.options.ignoreHiddenPoint;
            ...
            translate: function (a) {
                this.generatePoints();
                var b = 0, h = this.options, u = h.slicedOffset, p = u + (h.borderWidth || 0), m, d, r, l = h.startAngle || 0, f = this.startAngleRad = Math.PI / 180 * (l - 90), l = (this.endAngleRad = Math.PI / 180 * (q(h.endAngle, l + 360) - 90)) - f, n = this.points, e = h.dataLabels.distance, h = h.ignoreHiddenPoint, y, c = n.length, w;
            ...
            drawGraph: null,
            drawPoints: function () {
                var a = this, g = a.chart.renderer, h, u, p, m, d = a.options.shadow;
                ...
                E(a.points, function (b) {
                    if (null !== b.y) {
                        ...
                        u ? u.setRadialReference(a.center).attr(p).animate(F(m, h)) : (b.graphic =
                            u = g[b.shapeType](m).addClass(b.getClassName()).setRadialReference(a.center).attr(h).add(a.group), b.visible || u.attr({visibility: "hidden"}), u.attr(p).attr({"stroke-linejoin": "round"}).shadow(d, r))
                    }
                })
            },
            searchPoint: l,
            ...
            init: function () {
                ...
                var b = this, h = b.series, p = h.chart, m = h.options.ignoreHiddenPoint;
                g = q(g, m);
    ...
    (function (a) {
        var B =
            a.addEvent, C = a.arrayMax, E = a.defined, F = a.each, v = a.extend, l = a.format, q = a.map, x = a.merge, t = a.noop, n = a.pick, h = a.relativeLength, b = a.Series, g = a.seriesTypes, A = a.stableSort;
        ...
        b.prototype.drawDataLabels = function () {
            var a = this, b = a.options,
                g = b.dataLabels, d = a.points, h, q, f = a.hasRendered || 0, t, e, y = n(g.defer, !0), c = a.chart.renderer;
            if (g.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(g), e = a.plotGroup("dataLabelsGroup", "data-labels", y && !f ? "hidden" : "visible", g.zIndex || 6), y && (e.attr({opacity: +f}), f || B(a, "afterAnimate", function () {
                a.visible && e.show(!0);
                e[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), q = g, F(d, function (d) {
                var f, m = d.dataLabel, r, k, u = d.connector, p = !0, w, y = {};
                h = d.dlOptions || d.options && d.options.dataLabels;
                f = n(h && h.enabled, q.enabled) && null !== d.y;
                if (m && !f)d.dataLabel = m.destroy(); else if (f) {
                    g = x(q, h);
                    w = g.style;
                    f = g.rotation;
                    r = d.getLabelConfig();
                    ...
                    if (m)E(t) ? (m.attr({text: t}), p = !1) : (d.dataLabel = m = m.destroy(), u && (d.connector = u.destroy())); else if (E(t)) {
                        m = {
                            fill: g.backgroundColor,
        ...
        b.prototype.alignDataLabel = function (a, b, g, d, h) {
            var m = this.chart, f = m.inverted,
                r = n(a.plotX, -9999), e = n(a.plotY, -9999), u = b.getBBox(), c, p = g.rotation, l = g.align, q = this.visible && (a.series.forceDL || m.isInsidePlot(r, Math.round(e), f) || d && m.isInsidePlot(r, f ? d.x + 1 : d.y + d.height - 1, f)), t = "justify" === n(g.overflow, "justify");
            q && (c = g.style.fontSize, c = m.renderer.fontMetrics(c, b).b, d = v({
                x: f ? m.plotWidth - e : r,
                y: Math.round(f ? m.plotHeight - r : e),
                width: 0,
                height: 0
            }, d), v(g, {width: u.width, height: u.height}), p ? (t = !1, f = m.renderer.rotCorr(c, p), f = {
                x: d.x + g.x + d.width / 2 + f.x, y: d.y + g.y + {top: 0, middle: .5, bottom: 1}[g.verticalAlign] *
                d.height
            }, b[h ? "attr" : "animate"](f).attr({align: l}), r = (p + 720) % 360, r = 180 < r && 360 > r, "left" === l ? f.y -= r ? u.height : 0 : "center" === l ? (f.x -= u.width / 2, f.y -= u.height / 2) : "right" === l && (f.x -= u.width, f.y -= r ? 0 : u.height)) : (b.align(g, null, d), f = b.alignAttr), t ? this.justifyDataLabel(b, g, f, u, d, h) : n(g.crop, !0) && (q = m.isInsidePlot(f.x, f.y) && m.isInsidePlot(f.x + u.width, f.y + u.height)), g.shape && !p && b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
            q || (b.attr({y: -9999}), b.placed = !1)
        };
        b.prototype.justifyDataLabel = function (a, b, g, d, h, l) {
            var f =
                this.chart, m = b.align, e = b.verticalAlign, r, c, u = a.box ? 0 : a.padding || 0;
            r = g.x + u;
        ...
        g.pie && (g.pie.prototype.drawDataLabels = function () {
            var g = this, h = g.data, m, d = g.chart, r = g.options.dataLabels, l =
                n(r.connectorPadding, 10), f = n(r.connectorWidth, 1), t = d.plotWidth, e = d.plotHeight, y, c = r.distance, w = g.center, D = w[2] / 2, v = w[1], x = 0 < c, k, A, B, E, O = [[], []], N, J, S, Q, P = [0, 0, 0, 0];
            g.visible && (r.enabled || g._hasPointLabels) && (b.prototype.drawDataLabels.apply(g), F(h, function (a) {
                ...
                var h, u, p = b.length, n, y, G;
                if (p)for (g.sortByAngle(b, f - .5), 0 < c && (h = Math.max(0, v - D - c), u = Math.min(v + D + c, d.plotHeight), n = q(b, function (a) {
                    if (a.dataLabel)return G =
                        a.dataLabel.getBBox().height || 21, {target: a.labelPos[1] - h + G / 2, size: G, rank: a.y}
                ...
                if ((k = a.dataLabel) && k._pos && a.visible) {
                    ...
                    if (b = !y)a.connector = y = d.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(g.dataLabelsGroup), y.attr({
                        "stroke-width": f, stroke: r.connectorColor ||
                        a.color || "#666666"
                    });
                    y[b ? "attr" : "animate"]({d: g.connectorPath(a.labelPos)});
                    y.attr("visibility", S)
            ...
            var b = this.center, g = this.options, d = g.center, r = g.minSize || 80, l, f;
        ...
        g.column && (g.column.prototype.alignDataLabel = function (a, g, h, d, r) {
            var m = this.chart.inverted, f = a.series, l = a.dlBox || a.shapeArgs, e = n(a.below, a.plotY > n(this.translatedThreshold, f.yAxis.len)), u = n(h.inside, !!this.options.stacking);
    ...
    (function (a) {
        var B = a.Chart, C = a.each, E = a.pick, F = a.addEvent;
        B.prototype.callbacks.push(function (a) {
            function l() {
                var l = [];
                C(a.series, function (a) {
                    var q = a.options.dataLabels, n = a.dataLabelCollections || ["dataLabel"];
        ...
        B.prototype.hideOverlappingLabels = function (a) {
            var l = a.length, q, v, t, n, h, b, g, A, u, p = function (a, b, g, h, f, l, e, u) {
                return !(f > a + g || f + e < a || l > b + h || l + u < b)
            };
            for (v = 0; v < l; v++)if (q = a[v])q.oldOpacity = q.opacity, q.newOpacity = 1;
            a.sort(function (a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (v = 0; v < l; v++)for (t = a[v], q = v + 1; q < l; ++q)if (n = a[q], t && n && t.placed && n.placed && 0 !==
    ...
    (function (a) {
        var B = a.addEvent,
            C = a.Chart, E = a.createElement, F = a.css, v = a.defaultOptions, l = a.defaultPlotOptions, q = a.each, x = a.extend, t = a.fireEvent, n = a.hasTouch, h = a.inArray, b = a.isObject, g = a.Legend, A = a.merge, u = a.pick, p = a.Point, m = a.Series, d = a.seriesTypes, r = a.svg;
        a = a.TrackerMixin = {
            drawTrackerPoint: function () {
                var a = this, b = a.chart, d = b.pointer, e = function (a) {
                ...
                a._hasTracking || (q(a.trackerGroups, function (b) {
                    if (a[b]) {
                        ...
                        a.options.cursor && a[b].css(F).css({cursor: a.options.cursor})
                    }
                }), a._hasTracking = !0)
            }, drawTrackerGraph: function () {
                var a = this, b = a.options, d = b.trackByArea, e = [].concat(d ? a.areaPath : a.graphPath), g = e.length, c = a.chart, h = c.pointer, m = c.renderer, l = c.options.tooltip.snap,
                    u = a.tracker, k, p = function () {
                        if (c.hoverSeries !== a)a.onMouseOver()
                    }, t = "rgba(192,192,192," + (r ? .0001 : .002) + ")";
                if (g && !d)for (k = g + 1; k--;)"M" === e[k] && e.splice(k + 1, 0, e[k + 1] - l, e[k + 2], "L"), (k && "M" === e[k] || k === g) && e.splice(k, 0, "L", e[k - 2] + l, e[k - 1]);
                u ? u.attr({d: e}) : a.graph && (a.tracker = m.path(e).attr({
                    "stroke-linejoin": "round",
        ...
        x(g.prototype, {
            setItemEvents: function (a, b, d) {
                var e = this, f = e.chart, c = "highcharts-legend-" + (a.series ? "point" : "series") + "-active";
        ...
        x(C.prototype, {
            showResetZoom: function () {
                var a = this, b = v.lang, d = a.options.chart.resetZoomButton, e = d.theme, g = e.states, c = "chart" === d.relativeTo ? null : "plotBox";
            ...
            pan: function (a, b) {
                var d = this, e = d.hoverPoints, f;
                e && q(e, function (a) {
                    a.setState()
                });
                q("xy" === b ? [1, 0] : [1], function (b) {
                    b = d[b ? "xAxis" : "yAxis"][0];
                    var c = b.horiz, e = a[c ? "chartX" : "chartY"], c = c ? "mouseDownX" : "mouseDownY", g = d[c], h = (b.pointRange || 0) / 2, k = b.getExtremes(), m = b.toValue(g - e, !0) + h, h = b.toValue(g + b.len - e, !0) - h, r = h < m, g = r ? h : m, m = r ? m : h, h = Math.min(k.dataMin, k.min) - g, k = m - Math.max(k.dataMax, k.max);
                    b.series.length && 0 > h && 0 > k && (b.setExtremes(g, m, !1, !1, {trigger: "pan"}), f = !0);
                    d[c] = e
                });
                f && d.redraw(!1);
                F(d.container,
        ...
        x(p.prototype, {
            select: function (a, b) {
                ...
                var d = this.series, e = d.chart, f =
                    e.tooltip, c = e.hoverPoint;
                if (this.series) {
                    if (!b) {
                ...
                var d = Math.floor(this.plotX), e = this.plotY, f = this.series, c = f.options.states[a] || {}, g = l[f.type].marker && f.options.marker, h = g && !1 === g.enabled, m = g && g.states && g.states[a] || {}, r = !1 === m.enabled, k = f.stateMarkerGraphic, p = this.marker || {}, n = f.chart, q = f.halo, t, v = g && f.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === c.enabled || a && (r || h && !1 === m.enabled) || a && p.states &&
                    ...
                    if (this.graphic)this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.attr(f.pointAttribs(this, a)), t && this.graphic.animate(t, u(n.options.chart.animation, m.animation, g.animation)), k && k.hide(); else {
                        if (a && m) {
                            g = p.symbol || f.symbol;
                    ...
                    (d = c.halo) && d.size ? (q || (f.halo = q = n.renderer.path().add(v ? f.markerGroup : f.group)), q[b ? "animate" : "attr"]({d: this.haloPath(d.size)}), q.attr({"class": "highcharts-halo highcharts-color-" + u(this.colorIndex, f.colorIndex)}), q.point = this, q.attr(x({
                        fill: this.color || f.color,
                        "fill-opacity": d.opacity,
                        zIndex: -1
                    }, d.attributes))) : q && q.point &&
                    q.point.haloPath && q.animate({d: q.point.haloPath(0)});
                    this.state = a
                }
            }, haloPath: function (a) {
        ...
        x(m.prototype, {
            onMouseOver: function () {
                ...
                var a = this.options, b = this.chart, d = b.tooltip, e = b.hoverPoint;
                b.hoverSeries = null;
                if (e)e.onMouseOut();
                ...
                var b = this, d = b.options, e = b.graph, g = d.states, c = d.lineWidth, d = 0;
                a = a || "";
                if (b.state !== a && (q([b.group, b.markerGroup], function (c) {
                        c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a))
                    }), b.state = a, !g[a] || !1 !== g[a].enabled) && (a && (c = g[a].lineWidth || c + (g[a].lineWidthPlus || 0)), e && !e.dashstyle))for (g = {"stroke-width": c}, e.attr(g); b["zone-graph-" +
                d];)b["zone-graph-" + d].attr(g), d += 1
            }, setVisible: function (a, b) {
                var d = this, e = d.chart, f = d.legendItem, c, g = e.options.chart.ignoreHiddenSeries, h = d.visible;
    ...
    (function (a) {
        var B = a.Chart, C = a.each, E = a.inArray, F = a.isObject, v = a.pick, l = a.splat;
        ...
        B.prototype.matchResponsiveRule = function (l, x) {
            var q = this.respRules, n = l.condition, h;
        ...
        B.prototype.currentOptions = function (a) {
            function q(a, h, b) {
                var g, n;
                for (g in a)if (-1 < E(g, ["series", "xAxis", "yAxis"]))for (a[g] = l(a[g]), b[g] = [], n = 0; n < a[g].length; n++)b[g][n] = {}, q(a[g][n], h[g][n], b[g][n]); else F(a[g]) ? (b[g] = {}, q(a[g], h[g] || {}, b[g])) : b[g] = h[g] || null
            }
    ...
    (function (a) {
        var B = a.addEvent, C = a.Axis, E = a.Chart, F = a.css, v = a.dateFormat, l = a.defined, q = a.each, x = a.extend, t = a.noop, n = a.Series, h = a.timeUnits;
        a = a.wrap;
        ...
        a(C.prototype, "getTimeTicks", function (a, g, n, u, p, m, d, r) {
            var b = 0, f, q, e = {}, t, c, w, D = [], x = -Number.MAX_VALUE, A = this.options.tickPixelInterval;
        ...
        x(C.prototype, {
            beforeSetTickPositions: function () {
                var a, g = [], h = !1, l, p = this.getExtremes(), m = p.min, d = p.max, r, n = this.isXAxis && !!this.options.breaks, p = this.options.ordinal, f = this.chart.options.chart.ignoreHiddenSeries;
                if (p || n) {
                ...
                if (b) {
                    var h = this.ordinalSlope, l = this.ordinalOffset, m = b.length - 1, d;
                    if (g)0 > a ? a = b[0] : a > m ? a = b[m] : (m = Math.floor(a), d = a - m); else for (; m--;)if (g = h * m + l, a >= g) {
                        h = h * (m + 1) + l;
                        d = (a - g) / (h - g);
                        break
                    }
                ...
                var a = this.chart, g = this.series[0].currentDataGrouping, h = this.ordinalIndex, l = g ? g.count + g.unitName : "raw", p = this.getExtremes(), m, d;
                h || (h = this.ordinalIndex = {});
                h[l] || (m = {
                    series: [], chart: a, getExtremes: function () {
                        return {min: p.dataMin, max: p.dataMax}
                    }, options: {ordinal: !0}, val2lin: C.prototype.val2lin
                }, q(this.series, function (b) {
                    d = {xAxis: m, xData: b.xData, chart: a, destroyGroupedData: t};
                    d.options = {
                        dataGrouping: g ? {
                            enabled: !0, forced: !0, approximation: "open", units: [[g.unitName,
                                [g.count]]]
                        } : {enabled: !1}
                    };
        ...
        a(E.prototype, "pan", function (a, g) {
            var b = this.xAxis[0], h = g.chartX, l = !1;
            if (b.options.ordinal && b.series.length) {
                var m = this.mouseDownX, d = b.getExtremes(), r = d.dataMax, n = d.min, f = d.max, t = this.hoverPoints, e = b.closestPointRange, m = (m - h) / (b.translationSlope * (b.ordinalSlope || e)), v = {ordinalPositions: b.getExtendedPositions()}, e = b.lin2val, c = b.val2lin, w;
        ...
        n.prototype.gappedPath = function () {
            var a = this.options.gapSize, g = this.points.slice(),
                h = g.length - 1;
    ...
    (function (a) {
        ...
        var E = a.pick, F = a.wrap, v = a.each, l = a.extend, q = a.fireEvent, x = a.Axis, t = a.Series;
        l(x.prototype, {
            isInBreak: function (a, h) {
                var b = a.repeat || Infinity, g = a.from, l = a.to - a.from;
                h = h >= g ? (h -
                g) % b : b - (g - h) % b;
                return a.inclusive ? h <= l : h < l && 0 !== h
            }, isInAnyBreak: function (a, h) {
                var b = this.options.breaks, g = b && b.length, l, u, p;
                if (g) {
        ...
        F(x.prototype, "setTickPositions", function (a) {
            ...
            if (this.options.breaks) {
                var h = this.tickPositions, b = this.tickPositions.info, g = [], l;
        ...
        F(x.prototype, "init", function (a, h, b) {
            ...
            if (this.options.breaks) {
                ...
                this.val2lin = function (a) {
                    var b = a, h, m;
                    for (m = 0; m < g.breakArray.length; m++)if (h = g.breakArray[m], h.to <= a)b -= h.len; else if (h.from >= a)break; else if (g.isInBreak(h, a)) {
                        b -= a - h.from;
                        break
                    }
                    return b
                ...
                this.setAxisTranslation = function (a) {
                    ...
                    a = [];
                    var h = [], m = 0, d, l, n = g.userMin || g.min, f = g.userMax || g.max, t, e;
                    ...
                    for (e in b) {
                        ...
                        for (; t < n;)t += d;
                        for (; t < f; t += d)a.push({value: t, move: "in"}), a.push({
                            value: t + (l.to - l.from),
                            move: "out",
                            size: l.breakSize
                        })
        ...
        F(t.prototype, "generatePoints", function (a) {
            ...
            var h = this.xAxis, b = this.yAxis, g = this.points, l, n = g.length, p = this.options.connectNulls, m;
            if (h && b && (h.options.breaks || b.options.breaks))for (; n--;)l = g[n], m = null === l.y && !1 === p, m || !h.isInAnyBreak(l.x, !0) && !b.isInAnyBreak(l.y, !0) || (g.splice(n, 1), this.data[n] && this.data[n].destroyElements())
        });
        a.Series.prototype.drawBreaks = function (a, h) {
            var b = this, g = b.points, l, n, p, m;
            a && v(h, function (d) {
                l = a.breakArray || [];
                ...
                v(g, function (b) {
                    ...
                    v(l, function (d) {
                        p = !1;
                        if (n < d.from && m > d.to || n > d.from && m < d.from)p = "pointBreak"; else if (n < d.from && m > d.from && m < d.to || n > d.from && m > d.to && m < d.from)p = "pointInBreak";
                        p && q(a, p, {point: b, brk: d})
                    })
                })
            })
        };
    ...
    (function (a) {
        var B = a.arrayMax, C = a.arrayMin, E = a.Axis, F = a.defaultPlotOptions, v = a.defined, l = a.each, q = a.extend, x = a.format, t = a.isNumber, n = a.merge, h = a.pick, b = a.Point, g =
            a.Tooltip, A = a.wrap, u = a.Series.prototype, p = u.processData, m = u.generatePoints, d = u.destroy, r = {
        ...
        }, f = a.defaultDataGroupingUnits = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute",
            [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], z = {
            sum: function (a) {
                var b = a.length, c;
        ...
        u.groupData = function (a, b, c, d) {
            var e = this.data, f = this.options.data, g = [], k = [], h = [], l = a.length, m, r, n = !!b, w = [[], [], [], []];
            d = "function" === typeof d ? d : z[d];
            var p = this.pointArrayMap, u = p && p.length, q, v = 0;
            for (q = r = 0; q <= l && !(a[q] >= c[0]); q++);
            for (q; q <= l; q++) {
                for (; (void 0 !== c[v + 1] && a[q] >= c[v + 1] || q === l) &&
        ...
        u.processData = function () {
            var a = this.chart,
                b = this.options.dataGrouping, c = !1 !== this.allowDG && b && h(b.enabled, a.options.isStock), d = this.visible || !a.options.chart.ignoreHiddenSeries, g;
            this.forceCrop = c;
            this.groupPixelWidth = null;
            this.hasProcessed = !0;
            if (!1 !== p.apply(this, arguments) && c && d) {
                this.destroyGroupedData();
                var l = this.processedXData, m = this.processedYData, k = a.plotSizeX, a = this.xAxis, r = a.options.ordinal, n = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth();
                if (n) {
                    this.isDirty = g = !0;
                    d = a.getExtremes();
                    c = d.min;
        ...
        A(g.prototype, "tooltipFooterHeaderFormatter",
            function (b, d, c) {
                var e = d.series, f = e.tooltipOptions, g = e.options.dataGrouping, h = f.xDateFormat, k, l = e.xAxis, m = a.dateFormat;
                return l && "datetime" === l.options.type && g && t(d.key) ? (b = e.currentDataGrouping, g = g.dateTimeLabelFormats, b ? (l = g[b.unitName], 1 === b.count ? h = l[0] : (h = l[1], k = l[2])) : !h && g && (h = this.getXDateFormat(d, f, l)), h = m(h, d.key), k && (h += m(k, d.key + b.totalRange - 1)), x(f[(c ? "footer" : "header") + "Format"], {
                    point: q(d.point, {key: h}),
                    series: e
                })) : b.call(this, d, c)
            });
        u.destroy = function () {
            for (var a = this.groupedData ||
                [], b = a.length; b--;)a[b] && a[b].destroy();
            d.apply(this)
        };
        A(u, "setOptions", function (a, b) {
            a = a.call(this, b);
            var c = this.type, d = this.chart.options.plotOptions, e = F[c].dataGrouping;
        ...
        E.prototype.setDataGrouping = function (a, b) {
            ...
            if (this instanceof E)for (c = this.series.length; c--;)this.series[c].update({dataGrouping: a}, !1); else l(this.chart.options.series,
                function (b) {
                    b.dataGrouping = a
                }, !1);
            b && this.chart.redraw()
    ...
    (function (a) {
        var B = a.each, C = a.Point, E = a.seriesType, F = a.seriesTypes;
        E("ohlc", "column", {
            lineWidth: 1,
            ...
            pointArrayMap: ["open", "high", "low", "close"], toYData: function (a) {
            ...
            }, pointValKey: "high", pointAttribs: function (a, l) {
                ...
                var a = this, l = a.yAxis, q = !!a.modifyValue, x = ["plotOpen", "yBottom", "plotClose"];
                ...
                B(a.points, function (q) {
                    ...
                    void 0 !== q.plotY && (b || (q.graphic = b = l.renderer.path().add(a.group)), b.attr(a.pointAttribs(q, q.selected && "select")), t = b.strokeWidth() % 2 / 2, g = Math.round(q.plotX) - t, n = Math.round(q.shapeArgs.width / 2), h = ["M", g, Math.round(q.yBottom), "L", g, Math.round(q.plotY)], null !== q.open && (v = Math.round(q.plotOpen) + t, h.push("M", g, v, "L", g - n, v)), null !== q.close && (v = Math.round(q.plotClose) + t, h.push("M", g, v,
                        "L", g + n, v)), b[A ? "attr" : "animate"]({d: h}).addClass(q.getClassName(), !0))
                })
            }, animate: null
        }, {
            getClassName: function () {
    ...
    (function (a) {
        var B = a.defaultPlotOptions, C = a.each, E = a.merge, F = a.seriesType, v = a.seriesTypes;
        F("candlestick", "ohlc", E(B.column, {
            ...
            pointAttribs: function (a,
                                    q) {
                var l = v.column.prototype.pointAttribs.call(this, a, q), t = this.options, n = a.open < a.close, h = t.lineColor || this.color;
                ...
                C(a.points, function (l) {
                    var t = l.graphic, n, h, b, g, v, u, p, m = !t;
    ...
    (function (a) {
        var B =
            a.addEvent, C = a.each, E = a.merge, F = a.noop, v = a.Renderer, l = a.seriesType, q = a.seriesTypes, x = a.TrackerMixin, t = a.VMLRenderer, n = a.SVGRenderer.prototype.symbols;
        l("flags", "column", {
            pointRange: 0,
            shape: "flag",
            stackDistance: 12,
            ...
            sorted: !1, noSharedTooltip: !0, allowDG: !1, takeOrdinalPosition: !1, trackerGroups: ["markerGroup"],
            forceCrop: !0, init: a.Series.prototype.init, pointAttribs: function (a, b) {
                var g = this.options, h = a && a.color || this.color, l = g.lineColor, n = a && a.lineWidth;
                a = a && a.fillColor || g.fillColor;
                b && (a = g.states[b].fillColor, l = g.states[b].lineColor, n = g.states[b].lineWidth);
                return {fill: a || h, stroke: l || h, "stroke-width": n || g.lineWidth || 0}
            }, translate: function () {
                q.column.prototype.translate.apply(this);
                var a = this.options, b = this.chart, g = this.points, l = g.length - 1, n, p, m = a.onSeries;
                n = m && b.get(m);
                var a = a.onKey || "y", m = n && n.options.step,
                    d = n && n.points, r = d && d.length, t = this.xAxis, f = t.getExtremes(), v = 0, e, x, c;
                if (n && n.visible && r)for (v = (n.pointXOffset || 0) + (n.barW || 0) / 2, n = n.currentDataGrouping, x = d[r - 1].x + (n ? n.totalRange : 0), g.sort(function (a, b) {
                    return a.x - b.x
                ...
                var a = this.points, b = this.chart, g = b.renderer, l, n, p = this.options, m = p.y, d, r, q, f, t, e, v, c = this.yAxis;
                ...
                C(a, function (b) {
                    ...
                    g && B(g.element, "mouseover", function () {
                        0 < b.stackIndex && !b.raised && (b._y = g.y, g.attr({y: b._y - 8}), b.raised = !0);
                        C(a, function (a) {
                            a !== b && a.raised && a.graphic && (a.graphic.attr({y: a._y}), a.raised = !1)
                        })
                    })
                })
            }, animate: F, buildKDTree: F, setClip: F
        });
    ...
    (function (a) {
        ...
        var C = a.addEvent, E = a.Axis, F = a.correctFloat, v = a.defaultOptions, l = a.defined, q = a.destroyObjectProperties, x = a.doc, t = a.each, n = a.fireEvent, h = a.hasTouch, b = a.isTouchDevice, g = a.merge,
            A = a.pick, u = a.removeEvent, p = a.wrap, m = {
                height: b ? 20 : 14,
                barBorderRadius: 0,
        ...
        B.prototype = {
            init: function (a, b, h) {
                ...
                var a = this.renderer, b = this.options, g = this.size, f;
                ...
                var d = this.options.vertical, e = 0, h = this.rendered ? "animate" : "attr";
                this.x = a;
                ...
                this.track[h]({width: g, height: f});
                this.scrollbarButtons[1].attr({translateX: d ? 0 : g - b, translateY: d ? f - e : 0})
            }, drawScrollbarButton: function (a) {
                var b = this.renderer, d = this.scrollbarButtons, f = this.options, g = this.size, e;
                ...
                e.attr({fill: f.buttonArrowColor})
            }, swapXY: function (a, b) {
                var d = a.length, f;
                if (b)for (b = 0; b < d; b += 3)f = a[b +
                1], a[b + 1] = a[b + 2], a[b + 2] = f;
                return a
            }, setRange: function (a, b) {
                var d = this.options, f = d.vertical, g = d.minWidth, e = this.barWidth, h, c, m = this.rendered && !this.hasDragged ? "animate" : "attr";
                l(e) && (a = Math.max(a, 0), h = e * a, this.calculatedWidth = c = F(e * Math.min(b, 1) - h), c < g && (h = (e - g + c) * a, c = g), g = Math.floor(h + this.xOffset + this.yOffset), e = c / 2 - .5, this.from = a, this.to = b, f ? (this.scrollbarGroup[m]({translateY: g}), this.scrollbar[m]({height: c}), this.scrollbarRifles[m]({translateY: e}), this.scrollbarTop = g, this.scrollbarLeft = 0) : (this.scrollbarGroup[m]({translateX: g}),
                    this.scrollbar[m]({width: c}), this.scrollbarRifles[m]({translateX: e}), this.scrollbarLeft = g, this.scrollbarTop = 0), 12 >= c ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === d.showFull && (0 >= a && 1 <= b ? this.group.hide() : this.group.show()), this.rendered = !0)
            }, initEvents: function () {
                var a = this;
                a.mouseMoveHandler = function (b) {
                    var d = a.chart.pointer.normalize(b), f = a.options.vertical ? "chartY" : "chartX", g = a.initPositions;
                ...
                a.buttonToMinClick = function (b) {
                    ...
                    n(a, "changed", {from: a.from, to: a.to, trigger: "scrollbar", DOMEvent: b})
                };
                ...
                a.trackClick = function (b) {
                    var d = a.chart.pointer.normalize(b), f = a.to - a.from, g = a.y + a.scrollbarTop, e = a.x + a.scrollbarLeft;
        ...
        p(E.prototype, "init", function (a) {
            ...
            (b.options.scrollbar.vertical = !b.horiz, b.options.startOnTick = b.options.endOnTick = !1, b.scrollbar = new B(b.chart.renderer, b.options.scrollbar, b.chart), C(b.scrollbar, "changed", function (a) {
                var d = Math.min(A(b.options.min, b.min), b.min, b.dataMin), g = Math.max(A(b.options.max, b.max), b.max, b.dataMax) - d, e;
        ...
        p(E.prototype, "render", function (a) {
            var b = Math.min(A(this.options.min,
                this.min), this.min, this.dataMin), d = Math.max(A(this.options.max, this.max), this.max, this.dataMax), f = this.scrollbar, g;
        ...
        p(E.prototype, "getOffset", function (a) {
            var b = this.horiz ? 2 : 1, d = this.scrollbar;
            a.apply(this, [].slice.call(arguments, 1));
    ...
    (function (a) {
        ...
        B.prototype = {
            drawHandle: function (a, b) {
                ...
                this.rendered || (d[b] = c.path(["M", -4.5, .5, "L", 3.5, .5, 3.5, 15.5, -4.5, 15.5,
                    -4.5, .5, "M", -1.5, 4, "L", -1.5, 12, "M", .5, 4, "L", .5, 12]).attr({zIndex: 10 - b}).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][b]).add(), c = this.navigatorOptions.handles, d[b].attr({
                ...
                var e = this.chart, f = e.renderer, g, k, h, l;
                l = this.scrollbarHeight;
                var m = this.xAxis, n = this.navigatorOptions, p = n.maskInside, w = this.height, t = this.top, v = this.navigatorEnabled, D = this.outlineHeight, x;
                x = this.rendered;
                if (u(a) && u(b) && (!this.hasDragged || q(c)) && (this.navigatorLeft = g = r(m.left, e.plotLeft + l), this.navigatorWidth = k = r(m.len, e.plotWidth - 2 * l), this.scrollerLeft = h = g - l, this.scrollerWidth = l = l = k + 2 * l, c = r(c, m.translate(a)),
                    ...
                    !x && v && (this.navigatorGroup = c = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().addClass("highcharts-navigator-mask" + (p ? "-inside" :
                            "")).attr({fill: n.maskFill}).css(p && {cursor: "ew-resize"}).add(c), p || (this.rightShade = f.rect().addClass("highcharts-navigator-mask").attr({fill: n.maskFill}).add(c)), this.outline = f.path().addClass("highcharts-navigator-outline").attr({
                    ...
                    if (v) {
                        ...
                        p /= 2;
                        x = t + p;
                        this.leftShade[f](n.maskInside ? {x: g + a, y: t, width: b - a, height: w} : {
                            x: g,
                            y: t,
                            width: a,
                            height: w
                        ...
                        if (this.rightShade)this.rightShade[f]({
                            x: g +
                            b, y: t, width: k - b, height: w
                        });
                        this.outline[f]({d: ["M", h, x, "L", g + a - p, x, g + a - p, x + D, "L", g + b - p, x + D, "L", g + b - p, x, h + l, x].concat(n.maskInside ? ["M", g + a + p, x, "L", g + b - p, x] : [])});
                ...
                var a = this.chart, b = a.container,
                    c = this.mouseDownHandler, d = this.mouseMoveHandler, e = this.mouseUpHandler, f;
                ...
                C(a, "redraw", function () {
                    var a = this.scroller, b = a && (a.baseSeries && a.baseSeries[0] && a.baseSeries[0].xAxis || a.scrollbar && this.xAxis[0]);
                    b && a.render(b.min,
                        b.max)
                })
            }, removeEvents: function () {
                ...
                var b = a.options, c = b.navigator, e = c.enabled, b = b.scrollbar, g = b.enabled,
                    h = e ? c.height : 0, l = g ? b.height : 0;
                this.handles = [];
                this.scrollbarButtons = [];
                ...
                var n = this, p, r, e = n.baseSeries;
                n.mouseDownHandler = function (b) {
                    b = a.pointer.normalize(b);
                    var c = n.zoomedMin, d = n.zoomedMax, e = n.top, f = n.scrollerLeft, g = n.scrollerWidth, k = n.navigatorLeft, l = n.navigatorWidth, w = n.scrollbarPad ||
                        0, q = n.range, t = b.chartX, u = b.chartY;
                    b = a.xAxis[0];
                    var v, x = m ? 10 : 7;
                ...
                n.mouseMoveHandler = function (b) {
                    var c = n.scrollbarHeight, d = n.navigatorLeft, e = n.navigatorWidth, f = n.scrollerLeft, g = n.scrollerWidth, k = n.range, h;
                ...
                var b = a.xAxis.length, g = a.yAxis.length, t = e && e[0] && e[0].xAxis || a.xAxis[0];
                a.extraBottomMargin = n.outlineHeight + c.margin;
                a.isDirtyBox = !0;
                n.navigatorEnabled ? (n.xAxis = p = new E(a, d({offset: 0}, {
                    ...
                    translate: function (b, c) {
                        var d = a.xAxis[0], e = d.getExtremes(), f = a.plotWidth - 2 * l, g = w("min", d.options.min, e.dataMin), d = w("max", d.options.max, e.dataMax) - g;
                        return c ?
                        b * d / f + g : f * (b - g) / d
                    }, toFixedRange: E.prototype.toFixedRange, fake: !0
                };
                a.options.scrollbar.enabled && (a.scrollbar = n.scrollbar = new f(a.renderer, d(a.options.scrollbar, {margin: n.navigatorEnabled ? 0 : 10}), a), C(n.scrollbar, "changed", function (b) {
                    var c = n.navigatorWidth, d = c * this.to, c = c * this.from;
                ...
                var a = this, b = a.chart, c = a.series = [], e = a.baseSeries, f, g, h = a.navigatorOptions.series, l, m = {
                ...
                var a = this.chart.scroller, b = this.getExtremes(), c = b.dataMin, d = b.dataMax, b = b.max - b.min, e = a.stickToMin,
    ...
    (function (a) {
        ...
        var C = a.addEvent, E = a.Axis, F = a.Chart, v = a.css, l = a.createElement, q = a.dateFormat, x = a.defaultOptions, t = x.global.useUTC, n = a.defined, h = a.destroyObjectProperties, b = a.discardElement, g = a.each, A = a.extend, u = a.fireEvent, p = a.Date, m = a.isNumber, d = a.merge, r = a.pick, G = a.pInt, f = a.splat, z = a.wrap;
        A(x, {
            rangeSelector: {
        ...
        x.lang = d(x.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
        B.prototype = {
            clickButton: function (a, b) {
                var c = this, d = c.chart, e = c.buttonOptions[a], h = d.xAxis[0], l = d.scroller && d.scroller.getUnionExtremes() || h || {}, k = l.dataMin, n = l.dataMax, p, q = h && Math.round(Math.min(h.max, r(n, h.max))), u = e.type, v, l = e._range, x, y, z, A = e.dataGrouping;
                if (null !== k && null !== n) {
                    d.fixedRange = l;
                    A && (this.forcedDataGrouping = !0, E.prototype.setDataGrouping.call(h || {chart: this.chart}, A, !1));
                    if ("month" === u || "year" ===
                        u)h ? (u = {
                        range: e,
                        max: q,
                        dataMin: k,
                        dataMax: n
                    }, p = h.minFromRange.call(u), m(u.newMax) && (q = u.newMax)) : l = e; else if (l)p = Math.max(q - l, k), q = Math.min(p + l, n); else if ("ytd" === u)if (h)void 0 === n && (k = Number.MAX_VALUE, n = Number.MIN_VALUE, g(d.series, function (a) {
                        a = a.xData;
                        k = Math.min(a[0], k);
            ...
            updateButtonStates: function () {
                var a = this.chart, b = a.xAxis[0], c = Math.round(b.max - b.min), d = !b.hasVisibleSeries, a = a.scroller && a.scroller.getUnionExtremes() || b, f = a.dataMin, h = a.dataMax, a = this.getYTDExtremes(h, f, t), l = a.min, k = a.max, n = this.selected, p = m(n), q = this.options.allButtonsEnabled, r = this.buttons;
                g(this.buttonOptions, function (a, e) {
                    var g = a._range, m = a.type, t = a.count || 1;
                    a = r[e];
                    var w = 0;
                    e = e === n;
                    var u = g > h - f, v = g < b.minRange, x = !1, y = !1, g = g === c;
                    ("month" === m || "year" === m) && c >= 864E5 * {month: 28, year: 365}[m] * t && c <= 864E5 *
                    {
                        month: 31,
                        year: 366
            ...
            drawInput: function (a) {
                function b() {
                    var a =
                        p.value, b = (h.inputDateParser || Date.parse)(a), d = e.xAxis[0], f = e.scroller && e.scroller.xAxis ? e.scroller.xAxis : d, g = f.dataMin, f = f.dataMax;
                    b !== p.previousValue && (p.previousValue = b, m(b) || (b = a.split("-"), b = Date.UTC(G(b[0]), G(b[1]) - 1, G(b[2]))), m(b) && (t || (b += 6E4 * (new Date).getTimezoneOffset()), n ? b > c.maxInput.HCTime ? b = void 0 : b < g && (b = g) : b < c.minInput.HCTime ? b = void 0 : b > f && (b = f), void 0 !== b && d.setExtremes(n ? b : d.min, n ? d.max : b, void 0, void 0, {trigger: "rangeSelectorInput"})))
                }

                var c = this, e = c.chart, f = e.renderer.style || {},
                    g = e.renderer, h = e.options.rangeSelector, k = c.div, n = "min" === a, p, q, r = this.inputGroup;
                this[a + "Label"] = q = g.label(x.lang[n ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).addClass("highcharts-range-label").attr({padding: 2}).add(r);
                r.offset += q.width + 5;
                ...
                g.css(d({color: "#333333"}, f, h.inputStyle));
                v(p, A({
                    position: "absolute",
                    border: 0,
                    width: "1px",
            ...
            getYTDExtremes: function (a, b, c) {
                var d = new p(a), e = d[p.hcGetFullYear]();
            ...
            render: function (a, b) {
                var c = this, d = c.chart, e = d.renderer, f = d.container, h = d.options, k = h.exporting && !1 !== h.exporting.enabled && h.navigation && h.navigation.buttonOptions,
                    m = h.rangeSelector, p = c.buttons, h = x.lang, q = c.div, q = c.inputGroup, t = m.buttonTheme, u = m.buttonPosition || {}, v = m.inputEnabled, y = t && t.states, z = d.plotLeft, B, C = this.getPosition(), E = c.group, F = c.rendered;
                !1 !== m.enabled && (F || (c.group = E = e.g("range-selector-buttons").add(), c.zoomText = e.text(h.rangeSelectorZoom, r(u.x, z), 15).css(m.labelStyle).add(E), B = r(u.x, z) + c.zoomText.getBBox().width + 5, g(c.buttonOptions, function (a, b) {
                    p[b] = e.button(a.text, B, 0, function () {
                        ...
                        y.disabled).attr({"text-align": "center"}).add(E);
                    B += p[b].width + r(m.buttonSpacing, 5)
                }), !1 !== v && (c.div = q = l("div", null, {
                    position: "relative",
                    height: 0,
                    zIndex: 1
                }), f.parentNode.insertBefore(q, f), c.inputGroup = q = e.g("input-group").add(), q.offset = 0, c.drawInput("min"), c.drawInput("max"))), c.updateButtonStates(), E[F ? "animate" : "attr"]({translateY: C.buttonTop}), !1 !== v && (q.align(A({
                    y: C.inputTop,
                    width: q.offset,
            ...
            destroy: function () {
                var a = this.minInput, d = this.maxInput, c;
                this.unMouseDown();
                this.unResize();
                h(this.buttons);
        ...
        E.prototype.minFromRange = function () {
            var a = this.range, b = {
                month: "Month",
                year: "FullYear"
            }[a.type], c, d = this.max, f, g, h = function (a, c) {
                var d = new Date(a);
                d["set" + b](d["get" + b]() + c);
                return d.getTime() - a
            };
    ...
    (function (a) {
        ...
        a.Chart.prototype.callbacks.push(function (a) {
            ...
            var v, l = a.scroller, q = a.rangeSelector, x, t;
    ...
    (function (a) {
        var B = a.arrayMax, C = a.arrayMin, E = a.Axis, F = a.Chart, v = a.defined, l = a.each, q = a.extend, x = a.format, t = a.inArray, n = a.isNumber, h = a.isString, b = a.map, g = a.merge, A = a.pick, u = a.Point, p = a.Renderer, m = a.Series, d = a.splat, r = a.SVGRenderer, G = a.VMLRenderer, f = a.wrap,
            z = m.prototype, e = z.init, y = z.processData, c = u.prototype.tooltipFormatter;
        a.StockChart = a.stockChart = function (c, e, f) {
            var l = h(c) || c.nodeName, k = arguments[l ? 1 : 0], m = k.series, n = a.getOptions(), p, q = A(k.navigator && k.navigator.enabled, n.navigator.enabled, !0), r = q ? {
                startOnTick: !1,
                endOnTick: !1
            } : null, t = {marker: {enabled: !1, radius: 2}}, u = {shadow: !1, borderWidth: 0};
            k.xAxis = b(d(k.xAxis || {}), function (a) {
                return g({
                    ...
                    a, {type: "datetime", categories: null}, r)
            });
            k.yAxis = b(d(k.yAxis || {}), function (a) {
                p = A(a.opposite, !0);
                return g({labels: {y: -2}, opposite: p, showLastLabel: !1, title: {text: null}}, n.yAxis, a)
            });
            k.series = null;
            k = g({
                chart: {panning: !0, pinchType: "x"},
                navigator: {enabled: q},
                scrollbar: {enabled: A(n.scrollbar.enabled, !0)},
                rangeSelector: {enabled: A(n.rangeSelector.enabled, !0)},
                title: {text: null},
                tooltip: {shared: !0, crosshairs: !0},
                legend: {enabled: !1},
                plotOptions: {
                    line: t, spline: t, area: t, areaspline: t, arearange: t, areasplinerange: t,
                    column: u, columnrange: u, candlestick: u, ohlc: u
                }
            }, k, {isStock: !0, chart: {inverted: !1}});
            k.series = m;
        ...
        f(E.prototype, "getPlotLinePath", function (a,
                                                    c, d, e, f, g) {
            var k = this, m = this.isLinked && !this.series ? this.linkedParent.series : this.series, p = k.chart, q = p.renderer, r = k.left, u = k.top, w, x, y, z, D = [], B = [], C, E;
            ...
            l(k.isXAxis ? p.yAxis : p.xAxis, function (a) {
                if (v(a.options.id) ? -1 === a.options.id.indexOf("navigator") : 1) {
                    var b = a.isXAxis ? "yAxis" : "xAxis", b = v(a.options[b]) ?
        ...
        E.prototype.getPlotBandPath = function (a, b) {
            ...
            var c = [], d;
            if (a && b && a.toString() !== b.toString())for (d = 0; d < a.length; d += 6)c.push("M", a[d + 1], a[d + 2], "L", a[d + 4], a[d + 5], b[d + 4], b[d + 5], b[d + 1], b[d + 2], "z"); else c = null;
            return c
        };
        ...
        f(E.prototype, "drawCrosshair", function (a, b, c) {
            ...
            if (v(this.crosshair.label) && this.crosshair.label.enabled && this.cross) {
                ...
                d = this.opposite;
                e = this.left;
                var h = this.top, l = this.crossLabel, m, n = f.format,
                    p = "", r = "inside" === this.options.tickPosition, t = !1 !== this.crosshair.snap, u = 0;
                ...
                }).css(q({color: "#ffffff", fontWeight: "normal", fontSize: "11px", textAlign: "center"}, f.style)));
                ...
                l.attr({text: n ? x(n, {value: b}) : f.formatter.call(this, b), x: m, y: h, visibility: "visible"});
                b = l.getBBox();
                if (g) {
        ...
        z.processData = function () {
            ...
            if (this.xAxis && this.processedYData)for (c = this.processedXData, d = this.processedYData, e = d.length, this.pointArrayMap && (b = t("close", this.pointArrayMap), -1 === b && (b = t(this.pointValKey ||
                "y", this.pointArrayMap))), a = 0; a < e - 1; a++)if (f = -1 < b ? d[a][b] : d[a], n(f) && c[a + 1] >= this.xAxis.min && 0 !== f) {
                this.compareValue = f;
                break
            }
        };
        ...
        u.prototype.tooltipFormatter = function (b) {
            b = b.replace("{point.change}",
                (0 < this.change ? "+" : "") + a.numberFormat(this.change, A(this.series.tooltipOptions.changeDecimals, 2)));
